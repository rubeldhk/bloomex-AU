...
//live $gopeople_token = 'bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpYXQiOjE0OTE4NzA0NDIsImp0aSI6IllvV3BWTVl1WTFGK3Era2U3NnFoRFZGTkNNdTFTUTZLUWx2NVl3elNnc1E9IiwiaXNzIjoicGVvcGxlcG9zdC5jb20uYXUiLCJkYXRhIjp7InVzZXJJZCI6NTE0NH19.BoB-eJjn1Z95fAMXzwOj1gzaSqcW51mDoXFSoGqDRetwlbQ4Axzd93MvKlv9Xosy80eTCxJHfzt8Xt7sYBYRJg'; 
//dev $gopeople_token = 'bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpYXQiOjE0OTE4NzAyMzMsImp0aSI6IjlVSDhlRkFRVHVGcDZ2dWlHNTNoRGxSK3VnUnhYbTdWTHdSVGxHa2V5Z289IiwiaXNzIjoicGVvcGxlcG9zdC5jb20uYXUiLCJkYXRhIjp7InVzZXJJZCI6MzUwfX0.euIFQtsu4JN4DI_I8ClnpXYse9PyFG2_j8RQViCyuRNDoRHkG1Z96gtJs-itY1CNCEpzJIqa1FPPeVr0KAD_ZA'; 
...
function GoPeopleCancel() {
    global $gopeople_host, $gopeople_token, $mysqli, $mosConfig_status_sent_gopeople, $mosConfig_status_cancel_gopeople;
    ...
    if ($order_sql->num_rows > 0) {
        ...
        $history_sql = $mysqli->query("SELECT `comments` FROM `jos_vm_order_history` WHERE `order_id`=" . $order_id . " AND `order_status_code`='" . $mosConfig_status_sent_gopeople . "' ORDER BY `order_status_history_id` DESC LIMIT 1");
        $history_obj = $history_sql->fetch_object();

        if (preg_match('/JobID: ([^\.]+)/siu', $history_obj->comments, $job_id)) {
            $curl = curl_init();
            ...
            curl_setopt($curl, CURLOPT_URL, $gopeople_host . '/job?id=' . trim($job_id[1]));
            ...
            <div style="display: none;">
                ...
                Url: <pre><?php echo $gopeople_host . '/job?id=' . trim($job_id[1]); ?></pre>
...
function GoPeopleBook() {
    ...
    if ($order_sql->num_rows > 0) {
        ...
        if ($gopeople_response->errorCode == '0') {
            ...
            $history_comment = 'Tracking number: ' . $gopeople_response->result->trackingCode . ' JobID: ' . $gopeople_response->result->jobId . '.';
            ...
            VALUES
                (" . $order_id . ", '" . $mosConfig_status_sent_gopeople . "', '" . $mysqlDatetime . "', '" . $mysqli->real_escape_string($_SESSION['auth']['username']) . "', '" . $mysqli->real_escape_string($history_comment) . "')");
        } else {
            $return['result'] = false;
        ...
        if ($shipping_sql->num_rows > 0) {
            ...
            Switch ($_POST['warehouse']) {
                case 'WH15':
                    ...
                    $gopeople_data['addressFrom']['address1'] = '6 Ely Ct';
                    $gopeople_data['addressFrom']['suburb'] = 'Keilor East';
                    $gopeople_data['addressFrom']['state'] = 'VIC';
                    $gopeople_data['addressFrom']['postcode'] = '3033';
                    $gopeople_data['addressFrom']['contactName'] = 'Tammy';
                    //$gopeople_data['addressFrom']['contactNumber'] = '0426711306';
                    $gopeople_data['addressFrom']['sendUpdateSMS'] = false;
                    //$gopeople_data['addressFrom']['contactEmail'] = 'melbourne@bloomex.com.au';
                    $gopeople_data['addressFrom']['isCommercial'] = true;
                    $gopeople_data['addressFrom']['companyName'] = 'Bloomex';
                    break;

                case 'WH14':
                    $gopeople_data['addressFrom']['unit'] = 'Unit 1';
                    $gopeople_data['addressFrom']['address1'] = '23 Lathe Street';
                    $gopeople_data['addressFrom']['suburb'] = 'Virginia';
                    $gopeople_data['addressFrom']['state'] = 'QLD';
                    $gopeople_data['addressFrom']['postcode'] = '4014';
                    $gopeople_data['addressFrom']['contactName'] = 'Bloomex';
                    //$gopeople_data['addressFrom']['contactNumber'] = '02 8072 4146';
                    $gopeople_data['addressFrom']['sendUpdateSMS'] = false;
                    //$gopeople_data['addressFrom']['contactEmail'] = 'support@gopeople.com.au';
                    $gopeople_data['addressFrom']['isCommercial'] = true;
                    $gopeople_data['addressFrom']['companyName'] = 'Bloomex';
                    break;

                case 'WH12':
                    $gopeople_data['addressFrom']['unit'] = 'Unit 9';
                    $gopeople_data['addressFrom']['address1'] = '12-18 Victoria St E';
                    $gopeople_data['addressFrom']['suburb'] = 'Lidcombe';
                    $gopeople_data['addressFrom']['state'] = 'NSW';
                    $gopeople_data['addressFrom']['postcode'] = '2141';
                    $gopeople_data['addressFrom']['contactName'] = 'Bloomex';
                    //$gopeople_data['addressFrom']['contactNumber'] = '02 8072 4146';
                    $gopeople_data['addressFrom']['sendUpdateSMS'] = false;
                    //$gopeople_data['addressFrom']['contactEmail'] = 'support@gopeople.com.au';
...
function default_view() {
    ...
    if ($_POST['warehouse'] != 'WH12' AND $_POST['warehouse'] != 'WH14' AND $_POST['warehouse'] != 'WH15') {
        ...
        <html>
            <head>
                ...
                <script type="text/javascript">
                    ...
                    function GoPeopleBook(object_id, order_id, warehouse)
                    {
                                    ...
                                    if (data.result == true)
                                    {
                                        ...
                                        $j.each(data.price_list, function (k, v) {
                                            ...
                                            $j.each(v.prices, function (k1, v1) {
                                                gopeople_table += '<tr onclick="GoPeopleBook(\'' + v1.objectId + '\', ' + data.order_id + ', \'' + warehouse + '\');">';
                                                gopeople_table += '<td>';
                                            ...
                                            /*
                                             gopeople_table += '<tr onclick="GoPeopleBook(\''+v.objectId+'\', '+data.order_id+');">';
                                             gopeople_table += '<td>';
                                             gopeople_table += v.serviceName;
                                             gopeople_table += '</td>';
                                             gopeople_table += '<td>';
                                             gopeople_table += v.amount+' '+v.currency;
                                             gopeople_table += '</td>';
                                             gopeople_table += '<td>';
                                             gopeople_table += v.pickupAfter;
                                             gopeople_table += '</td>';
                                             gopeople_table += '<td>';
                                             gopeople_table += v.dropOffBy;
                                             gopeople_table += '</td>';
                                             gopeople_table += '</tr>';
                                             */
                                        });
                ...
                <div class="row" id="all_row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="col-xs-6 col-xs-offset-3">
                            <input onclick="FinishOrder();" id="sendfinish" wh="<?php echo htmlspecialchars($_POST['warehouse']); ?>" order_id="<?php echo $order_obj->order_id; ?>" class="btn btn-success btn-block" type="button" value="Proceed to pricing"/>
                        </form>
                    </div>
                </div>
