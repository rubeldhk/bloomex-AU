...
border="0">
   ...
   <TR>
      <TD class="borderLeft" width="28"></TD>
       <TD colSpan=2 width="731" height="193" align="left" valign="top" scope="col" style="background-position:8px 0;" background="<?php echo $mosConfig_live_site;?>/templates/bloomex7/images/bloomex_header_french_v3.jpg"  onclick="location.href='<?php echo $mosConfig_live_site;?>/index.php?page=shop.browse&category_id=73&option=com_virtuemart&Itemid=1&land=fr'" class="center-top-banner">
...
<TD align="center">
			<table width="100%" cellspacing="5" cellpadding="0" border="0">
				...
				<tr>
					<td align="center">
						<a href="/index.php?page=shop.browse&category_id=73&option=com_virtuemart&Itemid=1&lang=fr">
							<img border="0" alt=" " src="<?php echo $mosConfig_live_site;?>/templates/bloomex7/images/Fleurs-de-Saint-Valentin-et-Cadeaux.png" style="margin: 0px 0px 0px 0px">
						</a> 
					</td>
				</tr>
				</tbody>
