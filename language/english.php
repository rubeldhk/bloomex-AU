...
DEFINE('_LOGIN_BLOCKED','Your account has been blocked. We appreciate your past business but will not be able to serve you in future');
DEFINE('_LOGIN_INCORRECT','Incorrect Email or password. Please try again.');
...
DEFINE('_BUTTON_LOGIN','Sign In');
DEFINE('_BUTTON_GUEST','Guest Checkout');
DEFINE('_GUEST_CHECKOUT','Guest Checkout');
DEFINE('_CREATE_GUEST_ORDER','Create a quick order without an account.');
DEFINE('_BUTTON_LOGOUT','Logout');
DEFINE('_NO_ACCOUNT','No account yet?');
DEFINE('_CREATE_ACCOUNT','New to Bloomex? Create an Account');
...
DEFINE('_CORPORATE_CLIENT','Corporate Client?');
DEFINE('_APPLY_NOW','Apply Now');
DEFINE('_CORPORATE_CLIENT_DESC','Apply for exclusive business discounts and services.');
...
/** registration.php */
DEFINE('_ERROR_PASS','If the account exists, a password reset link will be sent to the registered email address');
...
.' Your USER NAME is: $checkusername\n\n'
...
DEFINE('_PROMPT_PASSWORD','Create Password');
DEFINE('_UPDATE_PASSWORD','Change Password');
DEFINE('_NEW_PASS_DESC','If the account exists, a password reset link will be sent to the registered email address.');
DEFINE('_STILL_HAVE_TROUBLE','Still having trouble logging in');
DEFINE('_UPDATE_PASSWORD_TIME_TO_TIME','We may from time to time update your password for security purposes.  In order to help our team troubleshoot your issues, we ask that you do the following:');
DEFINE('_CHECK_SPAM','Check your spam folders in case the reset email ended up there.');
DEFINE('_CONTACT_SUPPORT','Contact our support team by chat, phone or email to have your password reset, or place your order for you.');
DEFINE('_PROMPT_UNAME','Username');
DEFINE('_PROMPT_EMAIL','E-mail Address');
DEFINE('_BUTTON_SEND_PASS','Send');
...
DEFINE('_LOGIN_TEXT','<span style="color: rgb(102, 51, 102);">Please use your username and password to gain full access</span>');
...
DEFINE('_AJAX_WAITTING','Please wait while processing your request...');
DEFINE('_DELIVERY_CALENDAR','Delivery Calendar');
DEFINE('_DELIVERY_CALENDAR_NOTE','<b>Select a delivery date below</b><br/>Click on date below to choose the delivery date of your cart.');
DEFINE('_DELIVERY_CALENDAR_NOTE2','Step 2: Select your delivery date:');
DEFINE('_DELIVERY_SURCHARGE','Step 1: Select your delivery option:');
DEFINE('_DELIVERY_SPECIAL_DAY','Special Day');
DEFINE('_DELIVERY_EXTRA_SURCHARGE','Shipping Price Adjustment');
DEFINE('_DELIVERY_SAME_DAY','Same Day Delivery Surcharge');
DEFINE('_DELIVERY_FOLLOW_ADDRESS','Your Address Delivery');
DEFINE('_HOLIDAYS','Holidays');
DEFINE('_PAGE_TITLE_WINNIPEG','Bloomex Flowers Winnipeg|(204)-480-8584|Flower Delivery|Florists');
DEFINE('_PAGE_META_DESC_WINNIPEG','Looking for the freshest flowers at 50% the retail price? Bloomex Flowers Winnipeg can help! We\'re at 1119 Sanford Street, Winnipeg, MB R3E 3A1, Canada (204)-480-8584');
DEFINE('_PAGE_META_KEYWORDS_WINNIPEG','{city} flowers, {city} florist, {city} flower delivery, {city} Bloomex, {city} fresh flowers, {city} flower shop, {city} plants, {city} sympathy arrangements, {city} Mother\'s Day, {city} mother\'s day, {city} Mothers Day, {city} mothers day, {city} Mother Day, {city} mother day, {city} Valentine\'s Day, {city} Valentines Day, {city} flowers {province} Canada');
DEFINE('_PAGE_TITLE','{city} Flowers Online - {city} Florist Shop | {city} Flower Delivery | {city} Gift Baskets | Send Flowers Online to {city} - Bloomex.ca');
DEFINE('_PAGE_META_DESC','{city} Flowers Online,{city} Florist Shop, {city} Flower Delivery, {city} Gift Baskets, {city} Roses, send roses to {city}, Send Flowers Online to {city} , {city} Bloomex, {city} flowers, {city} florist, {city} same day flower delivery, {city} birthday flowers, {city} anniversary flowers, {city} funeral flowers, {city} valentine flowers, {city} mothers day flowers, {city} christmas flowers');
DEFINE('_PAGE_META_KEYWORDS','Bloomex {city} Flowers - Save 50% over other Local Florists. Send Flowers Online to {city} - Same Day {city} Flower Delivery. {city} Flowers and Gift Baskets for all Occasions - Birthday, Anniversary and Funeral Flowers.');
DEFINE('_BASKET_PAGE_TITLE','{city} Gift Baskets - {city} Fruit Baskets | {city} Gift Basket Delivery | {city} Corporate Gift Baskets | Send {city} Gift Baskets Online - Bloomex.ca');
DEFINE('_BASKET_PAGE_META_DESC','{city} Gift Baskets, {city} Fruit Baskets, {city} Gift Basket delivery, {city} Holiday Baskets, {city} Corporate gift Baskets, {city} Fruit Baskets');
DEFINE('_BASKET_PAGE_META_KEYWORDS','{city} Fruit & Gift Baskets - Save 50% - Shop for {city} Gift Baskets online. Same Day {city} Gift Basket Delivery - Order your Gift Basket Now & Save.');
?>
