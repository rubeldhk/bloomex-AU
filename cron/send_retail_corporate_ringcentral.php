...
global $mosConfig_host, $mosConfig_user, $mosConfig_password, $mosConfig_db, $mosConfig_ringcentral_client_id,
       ...
       $mosConfig_ringcentral_campaign_id_retail_corporate, $mosConfig_logger_file_path, $selectLimitOccasion,
...
if ($result->num_rows > 0) {
    $leads = [
        'description' => 'Bloomex Retail Corporate Calls',
...
if ($leads && count($leads['uploadLeads']) > 0) {
    try {
        ...
        $url = "admin/accounts/{$mosConfig_ringcentral_account_id}/campaigns/{$mosConfig_ringcentral_campaign_id_retail_corporate}/leadLoader/direct";
