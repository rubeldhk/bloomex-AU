...
function initSlideShow(element, data) {
    ...
    for (i = 0; i < data.length; i++)
    {
        ...
        var currentImg1 = document.createElement('img');
        currentImg1.src = data[i][0];
        currentImg1.alt = 'image';
        currentImg.appendChild(currentImg1);
        if (parseInt(i) === 1) {
            var ocounter = document.createElement('p');
//            ocounter.style.margin = "-21px 0px 0px 82px";
//            -----
//            ocounter.style.font = "15px arial black";
            var onumber = document.getElementById("onumber");
            onumber.style.float = "right";
            onumber.style.font = "14px Arial bold";
            onumber.style.margin = "-28px 250px 10px 10px";
            onumber.style.color = "#A13437";
            ocounter.innerHTML = onumber.innerHTML;
            currentImg.appendChild(ocounter);
        }
    }
