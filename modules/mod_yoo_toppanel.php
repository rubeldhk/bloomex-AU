...
require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'mod_yoo_toppanel' . DIRECTORY_SEPARATOR . 'helper.php');
...
$module_base       = $mosConfig_live_site . '/modules/mod_yoo_toppanel/';
...
switch ($style) {
	case "transparent":
   		require(modYOOtoppanelHelper::getLayoutPath('mod_yoo_toppanel', 'transparent'));
   		break;
	default:
    	require(modYOOtoppanelHelper::getLayoutPath('mod_yoo_toppanel', 'default'));
}

if ($GLOBALS['yoo_toppanels'] == 1) {  
	echo "<script src=\"" . $module_base . "mod_yoo_toppanel.js\" type=\"text/javascript\"></script>\n";
}
