...
if (!$bsqClassPath) die('$bsqClassPath is not defined. There is an include problem');
...
if(version_compare($bsqVersion, '2.0.0') < 0) {
	...
	$bsqRenderer = new BSQSitestatsRender('', true, $bsqJllog, $cacheTime);
	echo $bsqRenderer->visitorsLineGraph($imageWidth, $imageHeight, $cacheTime, $timeInterval);
