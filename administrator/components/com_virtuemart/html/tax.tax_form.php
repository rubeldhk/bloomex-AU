...
?><br />
    <script src="/templates/bloomex7/js/func.js?ref=0104"></script>
<table class="adminform">
    ...
    <tr> 
      ...
      <td>
        <?php $ps_html->list_country("tax_country", $db->sf("tax_country"), "onchange=\"changeStateList('tax_state', 'tax_country');\"",'tax_country') ?>
      </td>
    </tr>
    <tr align="center">
      <td colspan="2" >&nbsp;</td>
