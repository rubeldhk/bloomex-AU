...
?>
  ...
  <table class="adminform">
    ...
    <tr> 
      ...
      <tr>
          <td width="24%"><div align="right">Expiry Date:</div></td>
          <td width="76%">
              <input type="text" id="expiry_date" class="inputbox" name="expiry_date"  autocomplete="off"  value="<?php $db->sp("expiry_date"); ?>" />
          </td>
      </tr>
    <tr> 
