...
<table class="adminform">
    ...
    <tr>
        ...
        <td>
			   ...
			   <option value="product_list" <?php if (@VM_BROWSE_ORDERBY_FIELD == 'product_list') echo "selected=\"selected\""; ?>><?php echo $VM_LANG->_PHPSHOP_PRODUCT_ORDER_DEFAULT_MODIFIED ?></option>
    ...
    <tr>
        ...
        <td>
 					<input name="conf_VM_BROWSE_ORDERBY_FIELDS[]" type="checkbox" value="product_list" <?php if (in_array( 'product_list', $VM_BROWSE_ORDERBY_FIELDS )) echo "checked=\"checked\""; ?> id="conf_VM_BROWSE_ORDERBY_FIELDS5" />
                        <label for="conf_VM_BROWSE_ORDERBY_FIELDS5"><?php echo $VM_LANG->_PHPSHOP_PRODUCT_ORDER_DEFAULT_MODIFIED ?></label><br />
