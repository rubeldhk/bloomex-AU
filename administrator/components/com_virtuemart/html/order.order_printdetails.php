...
//$q = "SELECT * FROM #__{vm}_orders,#__{vm}_order_occasion WHERE (order_id='$order_id' and vendor_id = $ps_vendor_id and #__{vm}_orders.customer_occasion = #__{vm}_order_occasion.order_occasion_code)";
 ...
 <table width="100%" cellspacing="0" cellpadding="2" border="0">
        ...
        <tr> 
         ...
         ?><br><?php 
              ...
              echo "<br />";
              $dbbt->p("address_2");    
         ?>, <?php $dbbt->p("city"); ?>, <?php $dbbt->p("state"); ?>, <?php $dbbt->p("zip"); ?></td>
         <td><br/></td>
        </tr>
...
<br />
  ...
  <!-- Begin Payment Information --> 
      ...
      <!--<tr> 
        ...
        <td><?php 
           //echo ps_checkout::asterisk_pad($dbaccount->f("account_number"),4);
...
<tr>
        ...
        <td align="left"><?php echo nl2br($db->f("order_occasion_name"))."<br />"; ?>
       </td>
      </tr>
