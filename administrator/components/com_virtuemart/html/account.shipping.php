...
?>
   ...
   <?php echo $db->f("last_name") . " " .$db->f("first_name"); ?></a>
   </div>
   <br/>
<?php
  }
?>
   <br/><br/>
   <div>
      <a style="color:#FFF; padding:5px;" class="button" href="<?php $sess->purl(SECUREURL . "index.php?page=account.shipto&next_page=account.shipping"); ?>"><?php echo $VM_LANG->_PHPSHOP_USER_FORM_ADD_SHIPTO_LBL ?></a>
   </div>
</fieldset>
<!-- Body ends here -->
