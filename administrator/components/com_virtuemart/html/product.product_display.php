...
?></h2>
<?php
$q  = "SELECT *,s.full_image_link_webp,s.medium_image_link_webp FROM #__{vm}_product as p
 left join jos_vm_product_s3_images as s on s.product_id = p.product_id WHERE p.product_id='$product_id' ";
$db->query($q);                                                                                    
$db->next_record();
?>
<div align="center">
...
<div style="width:90%;float:left;">
	<fieldset>
		...
		<div class="formField"><?php $ps_product->show_image($db->f("medium_image_link_webp"), "", 0); ?></div>
	  
		<div class="formLabel"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_FULL_IMAGE ?>:</div>
		<div class="formField"><?php $ps_product->show_image($db->f("full_image_link_webp"), "", 0); ?></div>
