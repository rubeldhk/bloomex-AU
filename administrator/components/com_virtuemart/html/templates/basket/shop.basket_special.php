...
$auth = $_SESSION['auth'];
  if ($cart["idx"] == 0) {
     ...
     echo "<br><img src=\"images/cart_empty.png\" border=\"0\" title=\"Your cart is empty\">";
     $checkout = false;
  }
  else {
    $checkout = True;
    ...
    echo "<br /> <div id=\"bubble\"><a title=\"$scriptout\"><img src=\"images/cart_full.png\" border=\"0\"></a></div>";
  }
?>
