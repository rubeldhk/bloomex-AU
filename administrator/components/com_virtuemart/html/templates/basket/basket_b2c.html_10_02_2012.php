...
<input type="hidden" name="coupon_code_string" value="<?php echo ( isset($_SESSION['coupon_code']) ? $_SESSION['coupon_code'] : ""); ?>"/>
<input type="hidden" name="coupon_type_string" value="<?php echo ( isset($_SESSION['coupon_type']) ? $_SESSION['coupon_type'] : ""); ?>"/>
</form>