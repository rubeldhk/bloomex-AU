...
<?php } ?> -->
  ...
  <tr>
    <td colspan="5" align="right"><strong><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_TOTAL ?>:</strong></td>
...
<input type="hidden" name="sub_total_price" value="<?php echo floatval($total); ?>"/>
