...
<tr>
			  ...
			  <td><a href=index2.php?option=com_bsq_sitestats&act=iplookup&ip=<?php $db->p("ip_address"); ?> target=_blank><?php $db->p("ip_address"); ?></a></td>
			  </tr>
<tr>
			  <td><strong>CUSTOMER ID:</strong></td>
			  <td><?php $db->p("user_id"); ?></td></tr>
<tr><td>			
...
echo '<br><font color=red>it is strictly forbidden to provide any credit card information over the phone  or e-mail </font><br/>(CVV Code: DUE TO SECURITY REASONS NOT STORED IN DATABASE ) ';
}
?></td>
