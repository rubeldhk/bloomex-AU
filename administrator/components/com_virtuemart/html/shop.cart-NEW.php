...
<table width="400" border="0" cellspacing="0" cellpadding="0">
 ...
 <?php
   ...
   if (!defined('_MIN_POV_REACHED')) { ?>
       ...
       <br /><br />
           <span style="font-weight:bold;"><?php echo $VM_LANG->_PHPSHOP_CHECKOUT_ERR_MIN_POV2 . " ".$CURRENCY_DISPLAY->getFullValue($_SESSION['minimum_pov']) ?></span>	</td>	 
	<?php
   }
   else {
 ?><br /><br /><br />
    <td>
     ...
     <h3><a href="<?php $sess->purl( $mm_action_url . "index.php?page=checkout.index&ssl_redirect=1"); ?>"><?php echo $VM_LANG->_PHPSHOP_CHECKOUT_TITLE ?>
     </a><a href="<?php $sess->purl( $mm_action_url . "index.php?page=checkout.index&ssl_redirect=1"); ?>"><img src="<?php echo IMAGEURL ?>ps_image/forward.png" align="middle" width="32" height="32" alt="Forward" border="0" /></a></h3>
     <?php
 }
 ?>
