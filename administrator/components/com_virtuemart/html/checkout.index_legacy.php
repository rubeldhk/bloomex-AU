...
$_SESSION['checkout_shipping_method'] = 31;
...
?>
    ...
    <table border="0" cellspacing="0" cellpadding="5" width=100%" style="display: none"  class="checkout-standart">
    ...
    <div id="mainCheckOutForm">
        <table border="0" cellspacing="0" cellpadding="5" width="100%" class="checkout-standart">
            ...
            <tr>
                ...
                <td><?php $ps_html->list_user_occasion("customer_occasion", $db->sp("customer_occasion"), 'SYMP') ?></td>
            </tr>
                    <?php
        ...
        <table border="0" cellspacing="0" cellpadding="5" width="100%" class="checkout-standart">
            ...
            <tr>
                <td align="left" colspan="2">
                    <input style="vertical-align: middle;" name="payment_method_state" id="<?php echo $VM_LANG->_VM_CHECKOUT_CARD_LABEL; ?>" value="live" checked="checked" type="radio"><label style="vertical-align: middle;font-size: 12px;" for="<?php echo $VM_LANG->_VM_CHECKOUT_CARD_LABEL; ?>"><?php echo $VM_LANG->_VM_CHECKOUT_CARD_LABEL; ?></label>
                    <span class="payment_methods">
                        <img src="/templates/bloomex7/images/payment_methods/visa.png" alt="visa">
                        <img src="/templates/bloomex7/images/payment_methods/master_card.png" alt="master card">
                        <img src="/templates/bloomex7/images/payment_methods/american_express.png" alt="american express">
                        <img src="/templates/bloomex7/images/payment_methods/dinner_club.png" alt="dinner club">
                    </span>
                    <br/>
                    <input  style="display:none;vertical-align: top;" name="payment_method_state" id="<?php echo $VM_LANG->_VM_CHECKOUT_CARD_LABEL2; ?>" value="offline" type="radio"><label  style="display:none;vertical-align: top;font-size: 12px;" for="<?php echo $VM_LANG->_VM_CHECKOUT_CARD_LABEL2; ?>"><?php echo $VM_LANG->_VM_CHECKOUT_CARD_LABEL2; ?></label>
                </td>
            </tr>
<?php
                    ...
                    <div id="order-action-button">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="button" value="<?php echo $VM_LANG->_VM_SUBMIT_BUTTON; ?>" id="saveOrderAjax" class="new_checkout_upd_address_button" style="padding:5px; margin-top: 5px;"/>
                                </td>
                            </tr>
                        </table>
                    </div>
