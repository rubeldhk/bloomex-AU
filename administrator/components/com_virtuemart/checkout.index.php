...
<div style="display:none;" id="addShippingInfoForm" >
    <table border="0" cellspacing="0" cellpadding="0" width="100%"%" class="update-shipping-table">
        ...
        <tr>
           ...
           <td><input name="first_name_shipping" size="40" value="" class="inputbox" type="text"></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right" id="last_name_shipping"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_LAST_NAME ?>*:</b> </td>
           <td><input name="last_name_shipping" size="40" value="" class="inputbox" type="text"></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right" id="middle_name_shipping"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_MIDDLE_NAME ?>:</b> </td>
           <td><input name="middle_name_shipping" size="40" value="" class="inputbox" type="text"></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right" id="company_shipping"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_COMPANY_NAME ?>:</b> </td>
           <td><input name="company_shipping" size="40" value="" class="inputbox" type="text"></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right" id="address_1_shipping"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_ADDRESS_1 ?>*:</b> </td>
           <td><input name="address_1_shipping" size="40" value="" class="inputbox" type="text"></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_ADDRESS_2 ?>:</b> </td>
           <td><input name="address_2_shipping" size="40" value="" class="inputbox" type="text"></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right" id="city_shipping"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_CITY ?>*:</b> </td>
           <td><input name="city_shipping" size="40" value="" class="inputbox" type="text"></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right" id="zip_shipping"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_ZIP ?>*:</b> </td>
           <td><input name="zip_shipping" size="40" value="" class="inputbox" type="text" maxlength="7"></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right" id="td_country_shipping"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_COUNTRY ?>*:</b> </td>
           <td>
           		<input type="hidden" name="country_shipping" value="CAN"/>
           		<?php echo "Canada";//$ps_html->list_country("country_shipping", "CAN", "onchange='changeStateList(\"state_shipping\", \"country_shipping\");'", 'country_shipping');?>
           </td>
        </tr>
        <tr>
        ...
        <tr>
           ...
           <td><input type="text" name="phone_1_shipping" size="40" value="" class="inputbox" /></td>
        </tr>
        <tr>
           <td nowrap="nowrap" align="right"><b><?php echo $VM_LANG->_PHPSHOP_SHOPPER_FORM_PHONE2 ?>:</b> </td>
           <td><input type="text" name="phone_2_shipping" size="40" value="" class="inputbox" /></td>
        </tr>
        <tr>
           <td nowrap="nowrap"width="10%" align="right"><b><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_FAX ?>:</b> </td>
           <td><input type="text" name="fax_shipping" size="40" value="" class="inputbox" /></td>
        </tr>
         <tr>
         	<td>&nbsp;</td>
         	<td>
         		<input class="button" id="updateShippingInfo" value="<?php echo $VM_LANG->_PHPSHOP_USER_FORM_ADD_SHIPTO_LBL ?>" type="button" style="font-size:12px;float:left;padding:5px;"> 
         		<input class="button" id="closeShippingInfo" value="Close" type="button" style="float:right;margin:10px;">        		
...
<?php 
	echo $ps_html->dynamic_state_lists( "country_shipping", "state_shipping", "CAN", "", 'country_shipping', true );	 
	echo "<noscript>\n";
...
<script type="text/javascript">
    ...
    <?php	
        ...
        <table border="0" cellspacing="0" cellpadding="5" width="94%">
            ...
            <tr>
                <td colspan="2">
	                ...
	                <input  class="add-shipping-address button" type="button" value="<?php echo $VM_LANG->_PHPSHOP_ADD_SHIPTO_2 ?>"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
       ...
       <div id="mainCheckOutForm">
	       <table border="0" cellspacing="0" cellpadding="5" width="94%">
	            <tr class="sectiontableheader">
	           		<th align="left" colspan="2">Deliver Options</th>
	        	</tr>
	           <tr>
	           ...
	           <tr>
	               ...
	               ?>
	               <td width=28% style="padding:5px;">
	               <?php 
	               	printf( $VM_LANG->_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE2, $sTime); 
	               	echo " Bloomex Time is: ".date("h:i A", time());
	               ?>
	               </td>
	               <td valign=top>
	               <?php
		           		$ps_html->list_day("delivery_day2", date('j',time()), "onchange='noticeDeliver();'");	
		               
		               	$ps_html->list_month("delivery_month2", date('m',time()), "onchange='changeUnAvailableDate( this.value );noticeDeliver();'");
					...
					<!-- <div id='deliver_extra_same_day' style='padding:5px;color:red;display:none;'>&nbsp;</div> -->";
	               ?>
	               ...
	               <input type="hidden" name="current_state_tax" value="<?php echo $sCurrentStateTax; ?>" />
	               ...
	               <script type="text/javascript">
	           			...
	           			//alert(oForm.zip_checked.value);
	               		if( parseFloat(oForm.cutofftime.value) > 0 ) {
	               			changDeliver(oForm.zip_checked.value);
	               		}
	               		               		
	               		if( oForm.zip_checked.value ) {
	               			changDeliver(oForm.zip_checked.value);
	               		}   
	               		
	               		//alert( parseFloat(oForm.daysofmonthnow.value) + "====" + parseFloat(nMonthsValid) );
	               		if( parseFloat(nMonthsValid) > 0 ) {
	               			changeUnAvailableDate( parseFloat(nMonthsValid) );
	               		}else {
	               			changeUnAvailableDate( parseFloat(oForm.monthnow.value) );
	               		}
	               		              		
	               		if( ( nDeliverFeeExtraSameDay && $j("#deliver_extra_same_day").html() == "") || parseFloat(nDeliverFeeExtraSameDay) > 0  ) {
...
//	               		noticeDeliver();
	        ...
	        <table border="0" cellspacing="0" cellpadding="5" width="94%">
	            <tr class="sectiontableheader">
					<th align="left" colspan="2">Payment Method ( <font color="red">* Required</font> )</th>
				</tr>
				<tr>
				...
				?>
				<tr>
					<td width="30%" ><b>Credit Card Type<font color="red">*</font></b>:</td>
					<td width="70%" ><?php echo $aInfomation['payment_method'];?></td>
				</tr>
				<tr>
					<td><b>Name On Card<font color="red">*</font></b>:</td>
					<td><input type="text" name="name_on_card" value="" size="30" /></td>
				</tr>
				<tr>
					<td><b>Credit Card Number<font color="red">*</font></b>:</td>
					<td><input type="text" name="credit_card_number" value="" size="30" maxlength="16" /></td>
				</tr>
				<tr>
					<td><b>Credit Card Security Code<font color="red">*</font></b>:</td>
				...
				<?php 
					...
					$aInfomation['expire_year']		= listYear( "expire_year", date("Y"), " size='1' ", 13, date("Y") );
				?>
				<tr>
					<td><b>Expiration Date<font color="red">*</font></b>:</td>
				...
				<tr>
					...
					<td class="calculate-price" style="font-style:italic;">
						Attention!<br/>
						Name On Card: exactly as appeared on your card<br/>
						Credit Card number: 16 (VISA, MC) or 15 (AMEX) digits, no spaces<br/>
					</td>
				</tr>
			</table>
	       <table border="0" cellspacing="0" cellpadding="5" width="94%">
	        <tr class="sectiontableheader">
				<th colspan="2" align="left">Order Price Detail</th>
			</tr>
			<tr>
				<td width="30%" ><b>Total Items Price:</b> </td>
				<td width="70%" class="calculate-price" id="calcualte-total-items-price">N/A</td>
			</tr>
			<tr>
				<td width="30%" ><b>Items Tax:</b> </td>
				<td width="70%" class="calculate-price" id="calcualte-tax-items-price">N/A</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<input type="button" value="Calculate Order Price" id="calculateOrderPrice" class="button" />&nbsp;&nbsp;&nbsp;
					<input type="button" value="Submit Order" id="saveOrder" class="button button-bigger" />				
				</td>
			</tr>
		</table>
	</div>
