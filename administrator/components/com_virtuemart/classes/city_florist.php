...
border="0">
   ...
   <TR>
      <TD class="borderLeft" width="28"></TD>
      <TD colSpan=2 width="731" height="193" align="left" valign="top" scope="col" style="background-position:8px 0;" background="<?php echo $mosConfig_live_site;?>/templates/bloomex7/images/bloomex_header_v3.jpg"  onclick="location.href='<?php echo $mosConfig_live_site;?>'" class="center-top-banner">
...
<a href="/index.php?page=shop.browse&amp;category_id=83&amp;option=com_virtuemart&amp;Itemid=73"><img style="margin: 0px 0px 0px 1px" src="/templates/bloomex7/images/GB_banner-sm.gif" border="0" alt=" "></a> </td></tr>
				</tbody>
			</table>
