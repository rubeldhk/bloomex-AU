...
class vmPageNav {
	...
	*/
	function getLimitBox () {
		...
		$limits[] = mosHTML::makeOption( "50" );
                ...
                $limits[] = mosHTML::makeOption( "2000" );
	...
	*/
	...
	function getListFooter($showPagination = true) {
	    $html = '<table class="adminlist">';
	    if( $this->total > $this->limit || $this->limitstart > 0) {
	    	
		    $html .= '<tr><th colspan="3" style="text-align: center">';
		...
		if($showPagination){
		 ...
		 $html .= '<td>' .$this->getLimitBox() . '   ' . $this->getPagesCounter() . '</td></tr>';
        }
		$html .= '</table>';
  		return $html;
	}
