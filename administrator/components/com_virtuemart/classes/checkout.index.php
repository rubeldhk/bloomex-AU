...
global $VM_LANG;
$aM	= array('coupon_id', 'coupon_type', 'coupon_discount', 'coupon_code', 'coupon_value', 'coupon_code_type', 'coupon_redeemed');
					foreach($aM as $am_t ){
						unset($_SESSION[$am_t]);
					}
		print_r($_SESSION['cart']);
		echo"<br/>";
		$aM	= array('coupon_id', 'coupon_type', 'coupon_discount', 'coupon_code', 'coupon_value', 'coupon_code_type');
		foreach($aM as $am_t ){
			echo $am_t.": ".$_SESSION[$am_t]."<br/>";
		}
?>
...
<form action="<?php echo SECUREURL ?>index.php" method="post" name="adminForm" id="adminForm">
    ...
    <input type="hidden" name="coupon_value" value="<?php echo isset($_SESSION['coupon_value']) ? $_SESSION['coupon_value'] : ""; ?>" />
...
<div style="display:none;" id="addShippingInfoForm" >
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="update-shipping-table">
        ...
        <tr>
           ...
           <td>
           		<input type="hidden" name="country_shipping" value="USA"/>
           		<?php echo "USA";//$ps_html->list_country("country_shipping", "USA", "onchange='changeStateList(\"state_shipping\", \"country_shipping\");'", 'country_shipping');?>
           </td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
         	...
         	<td>
         		...
         		<input class="button" id="closeShippingInfo" value="<?php echo $VM_LANG->_VM_CLOSE ?>" type="button" style="float:right;margin:10px;">        		
...
<?php 
	echo $ps_html->dynamic_state_lists( "country_shipping", "state_shipping", "USA", "", 'country_shipping', true );	 
	echo "<noscript>\n";
...
<script type="text/javascript">
    ...
    <?php	
	   ...
	   <tr>
                <td colspan="2">
	                <?php echo  strip_tags($VM_LANG->_PHPSHOP_ADD_SHIPTO_1); ?>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
	                Only 1 delivery address can be selected per order. For multiple delivery locations, please go through <a href="index.php?option=com_content&task=view&id=41&Itemid=242" target="_blank">corporate</a>
                </td>
            </tr>
        </table>
       <br/><br/>
       ...
       <div id="mainCheckOutForm">
	       <table border="0" cellspacing="0" cellpadding="5" width="94%">
	          ...
	          <!-- <tr>
	           ...
	           <tr>
	               ...
	               ?>
	               <td width=28% style="padding:5px;"><?php echo $VM_LANG->_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE2; ?>:</td>
	               <td valign=top>
	               	<div style="display:none;" id="selectDeliveryOption" >&nbsp;</div>
	                <input type="text" name="delivery_date_2" id="delivery_date_2" readonly="readonly" re maxlength="10" />	
	                <img src="<?php echo $mosConfig_live_site; ?>/templates/bloomex7/images/<?php echo $sCalendarImg; ?>" id="btnSelectDeliveryOption" align="absmiddle"  style="cursor:pointer;margin:0px 0px 0px 0px;" />									
	               ...
	               <script type="text/javascript">
	               		...
	               		changDeliver(oForm.zip_checked.value, $j("input[name='current_state_tax']").val());
	        ...
	        <table border="0" cellspacing="0" cellpadding="5" width="94%">
				...
				<?php 
					...
					$aInfomation['expire_year']		= listYear( "expire_year", date("Y"), " size='1' ", 9, date("Y") );
				?>
				<tr>
	       ...
	       <table border="0" cellspacing="0" cellpadding="5" width="94%">
			...
			<tr>
				<td><b><?php echo $VM_LANG->_VM_DELIVERY_SURCHARGE; ?></b></td>
				<td class="calculate-price" id="calcualte-extra-deliver-fee">N/A</td>
			</tr>
			<tr>
				<td><b><?php echo $VM_LANG->_VM_TOTAL_DELIVERY; ?></b></td>
			...
			<tr>
				...
				<td>
					...
					<div id="order-action-button">
						<input type="button" value="<?php echo $VM_LANG->_VM_CALCULATE_BUTTON; ?>" id="calculateOrderPrice" class="button" style="padding:5px;" />&nbsp;&nbsp;&nbsp;
						<input type="button" value="<?php echo $VM_LANG->_VM_SUBMIT_BUTTON; ?>" id="saveOrder" class="button button-bigger" />				
					</div>
				</td>
			</tr>
		</table>
