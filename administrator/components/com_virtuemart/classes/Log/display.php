...
class Log_display extends vmLog
{
    ...
    function formatOutput( $message, $priority) {
    	...
    	elseif( $priority >= PEAR_LOG_ERR ) {
    		//return '<div class="shop_error1">'. $message . '</div>';
            return '<div class="container"><div class="row"><div class="col-xs-12"><div class="alert alert-warning">'. $message . '</div></div></div></div>';
    	}
