...
class ps_product_price {
	...
	***************************************************************************/
	function add(&$d) {
		...
		$q .= "product_price_edate,cdate,price_quantity_start,price_quantity_end, saving_price, compare_at,discount_for_customer) ";
		//old $q .= "product_price_edate,cdate,mdate,price_quantity_start,price_quantity_end, saving_price, compare_at) ";
		...
		$q .= "'$timestamp','".$d["price_quantity_start"]."','".$d["price_quantity_end"]."','".$d["saving_price"]."','".$d["compare_at"]."','".$d["discount_for_customer"]."')";
		//old $q .= "'$timestamp','$timestamp', '".$d["price_quantity_start"]."','".$d["price_quantity_end"]."','".$d["saving_price"]."','".$d["compare_at"]."')";
	...
	***************************************************************************/
	function update(&$d) {
		...
		$q .= "saving_price='" . $d["saving_price"] . "',";
		$q .= "discount_for_customer='" . $d["discount_for_customer"] . "',";
                $q .= "compare_at='" . $d["compare_at"] . "'";
		//$q .= "mdate='$timestamp' ";
