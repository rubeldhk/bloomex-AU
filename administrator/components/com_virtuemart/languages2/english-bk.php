...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_ADD_SHIPTO_2 = '<u>Delivery Address</u>';
	...
	var $_PHPSHOP_EMPTY_CART = '<p><b>Your Cart is currently empty.</b> <p><font size=1><i>If you are experiencing difficulties with placing an order online, please call our toll free number 888-912-5666 to place your order over the phone</i></font>';
...
information available,<br> please enter "Na" in appropriate field</b>';
	...
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE = '<b><font color=red>DELIVERY DATE ---> </font></b><br><small><font color=red>Attention! Same day orders cut off time 1:00pm EST.</b></font></small>';
	...
	var $_PHPSHOP_ORDER_PRINT_FIND_US = '<b>How did yor find us</b>';
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_THANKYOU_SUCCESS = 'Your order has been successfully placed! Your credit card transaction processed and approved!<p>
...
Please read our return policy for more information on our satisfaction guarantee. <a href=http://bloomex.ca/index.php?option=com_content&task=view&id=37&Itemid=237&lang=en><b><u>Return Policy</u></b></a>. ';
