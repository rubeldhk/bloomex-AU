...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_ADD_SHIPTO_1 = '<p><b><font color=red>Important.</font></b><br> Please add the delivery address if it is not listed below <b>before</b> you click   <b> next>></b> button. <p><b>Add </b> ';
	var $_PHPSHOP_ADD_SHIPTO_2 = 'Delivery Address';
	...
	var $_PHPSHOP_REMINDER_THANK = '<center>Thank you for registering with Bloomex reminder service.<br/> Your reminder email will be send to you in 3 day in advance.</center>';
...
<a href=http://bloomexusa.com/index.php?option=com_registration&task=lostPassword><u>Click to Login</u></a>Lost password? <a href=http://bloomexusa.com/index.php?option=com_registration&task=lostPassword><u>Click here</u></a><br>
New to our website? To register <a href=http://bloomexusa.com/index.php?option=com_registration&task=lostPassword><u>click here</u><a/>';
...
information available,<br> please enter "Na" in appropriate field</b>';
	...
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE = '<b><font color=red>DELIVERY DATE ---> </font></b><br><small><font color=red>Attention! Same day orders cut off time 1:00pm local time.</b></font></small>';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE2 = '<b><font color=red>DELIVERY DATE ---> </font></b><br><small><font color=red>Attention! Same day orders cut off time %s local time.</b></font></small>';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE3 = 'Now is cut off time, please choose next days from now to deliver';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE4 = 'Your deliver date is invalid! Please choose day and month again!';	
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE5 = 'Please choose day to deliver';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE6 = 'Please choose month to delver';
	...
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE77 = 'Additional  <b> ${price}</b> delivery fee will apply for your address delivery.';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE8 = 'Deliver date is not available! Please choose day and month again!';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE9 = 'Additional  <b> ${price}</b> delivery fee will apply for same day delivery.';
	...
	var $_PHPSHOP_INCLUDING_TAX = '(including $tax % tax)123123123123';
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_UPS = '<a href="http://www.ups.com" target="_blank">UPS OnlineпїЅ Tools</a> Shipping calculation';
...
To ensure that notifications about status of your order are not sent to your Hotmail Junk E-Mail folder, we suggest you to add bloomexusa.com to your Hotmail Safe List. If you are not sure how to add an address to your email safe list, <a href=http://bloomexusa.com/movies/hotmail/ target=_blank><u>check this short (35sec) movie</u></a> (opens new window) .<p>
 <font color=red><b>Attention Customer</b></font>:<br>
Please read our return policy for more information on our satisfaction guarantee. <a href=http://bloomexusa.com/index.php?option=com_content&task=view&id=35&Itemid=230&lang=en><b><u>Return Policy</u></b></a>. 
<script src="https://ssl.google-analytics.com/urchin.js" type="text/javascript"></script>
<script type="text/javascript">_uacct = "UA-232639-1";urchinTracker();</script>
...
var google_conversion_label = "P5ifCJfcPhCxwvj8Aw";
//-->
</script>
...
src="https://www.googleadservices.com/pagead/conversion/1067327793/?label=P5ifCJfcPhCxwvj8Aw&script=0">
</noscript>
...
';
	...
	var $_PHPSHOP_CURRENCY_SYMBOL_TOOLTIP = 'You can also use HTML Entities here (e.g. пїЅ,пїЅ,пїЅ,...)';
...
';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_0 = 'Thank you for your business with Bloomex. It is very much appreciated.
You can always view, or print your order online. Just login to your account at http://bloomexusa.com. ';
...
More details:  http://bloomexusa.com/index.php?page=reminder.index&option=com_virtuemart&Itemid=190';
...
Credit Card number: 16 (VISA, MC) or 15 (AMEX) digits, no spaces</font></b><br>';
     ...
     var $_VM_NO_SHIPPING_ADDRESS =  'Please add deliver address to continue!';
}
