...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_DECLINE = 'Your transaction has been declined. Please check accuracy of credit card information entered. If  problem persists, please call us at 1-888-912-5666';
	var $_PHPSHOP_APPROVED = 'Your transaction has been approved!';
	var $_PHPSHOP_UNKNOWN_ERROR = 'There was error processing your transaction.  Please call us toll free at 1-888-912-5666 and one of our representatives will be glad to help.';
	...
	var $_PHPSHOP_REMINDER_THANK = '<center>Thank you for registering with bloomex.ca reminder service.<br/> Your reminder email will be send to you in 3 day in advance.</center>';
	...
	var $_PHPSHOP_EMPTY_CART = '<p><b>Your Cart is empty.</b> <br><font size=1><i> Phone orders:<br> 1-888-912-5666</i></font>';
...
<a href=http://bloomex.ca/index.php?option=com_registration&task=lostPassword><u>Click to Login</u></a>Lost password? <a href=http://bloomex.ca/index.php?option=com_registration&task=lostPassword><u>Click here</u></a><br>
New to our website? To register <a href=http://bloomex.ca/index.php?option=com_registration&task=lostPassword><u>click here</u><a/>';
...
information available,<br> please enter "Na" in appropriate field</b>';
	...
	var $_PHPSHOP_CHECKOUT_CUSTOMER_NOTE = '<b>Card Message</b> <br><small>(It will be printed <br>exactly as you entered)</small>';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_OCCASION = '<b>Occasion </b>';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_SIGNATURE = '<b>Signature </b>';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE = '<b><font color=red>DELIVERY DATE ---> </font></b><br><small><font color=red>Attention! Same day orders cut off time 1:00pm bloomex.ca time.</b></font></small>';
	...
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE7 = 'You must include <b> ${price}</b> and <b>{day}</b> day(s) from today for deliverance follow your address';
	...
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_COMMENTS = '<b>Instructions and comments </b><br><small> (we will keep  this <br>information confidential)</small>';
	var $_PHPSHOP_ORDER_PRINT_FIND_US = '<b>How did you find us</b>';
	var $_PHPSHOP_ORDER_PRINT_FIND_US2 = '<b>Reminder</b>';
	var $_PHPSHOP_ORDER_PRINT_FIND_US_2 = '<b>Would you like to signup for reminder<b>';
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_THANKYOU_SUCCESS = '  Your order has been successfully placed! {paymentMsg}<p>
										...
										To ensure that notifications about status of your order are not sent to your Hotmail Junk E-Mail folder, we suggest you to add bloomex.ca to your Hotmail Safe List. If you are not sure how to add an address to your email safe list, <a href=http://bloomex.ca/movies/hotmail/ target=_blank><u>check this short (35sec) movie</u></a> (opens new window) .<p>
										<font color=red><b>Attention Customer</b></font>:<br>
										Please read our return policy for more information on our satisfaction guarantee. <a href=http://bloomex.ca/index.php?option=com_content&task=view&id=35&Itemid=230&lang=en><b><u>Return Policy</u></b></a>. 										
...
';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_0 = 'Thank you for your business with bloomex.ca. It is very much appreciated.
You can always view, or print your order online. Just login to your account at http://bloomex.ca. ';
	...
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_5 = 'If you have any questions call us toll free at: 1-888-912-5666';
...
More details:  http://bloomex.ca/index.php?page=reminder.index&option=com_virtuemart&Itemid=190';
...
Credit Card number: 16 (VISA, MC) or 15 (AMEX) digits, no spaces</font></b><br>';
     ...
     var $_VM_CONFIRM_VALID_ZIP_CODE				=  'Please enter your zip code again!\n Example: K2E 7X3 (LDL DLD . Where L= letter , D = number)';
	...
	var $_VM_ADD_DELIVER_INFO_UNSUCCESSFUL			=  "Delivery address was not added successfully!";
     ...
     var $_VM_BLOOMEX_TIME						 	=  'bloomex.ca time is:';
     var $_VM_REQUIRED						 		=  'Required';
     var $_VM_CHECKOUT_CARD_LABEL			 		=  'Visa, Master Card, American Express';
     ...
     var $_VM_TOTAL_ITEMS_PRICE						=  'Total Items Price:';
     ...
     var $_VM_CANNOT_DELIVER						=  'We are unable to deliver to this location please select a different location';
