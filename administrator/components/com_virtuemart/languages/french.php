...
class vmLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_DECLINE = 'Votre transaction a été refusée.';
	var $_PHPSHOP_APPROVED = 'Your transaction has been acceptée!';
	var $_PHPSHOP_UNKNOWN_ERROR = 'Le système a rencontré une erreur durant votre transaction automatisée. SVP, composez le 1-800-905-147 pour de l\'aide d\'un de nos représentant.';
	...
	var $_PHPSHOP_LATEST = 'Nouveautés';
	...
	var $_PHPSHOP_PRODUCT_SEARCH_LBL = 'Rechercher du produit';
	var $_PHPSHOP_PRODUCT_NAME_TITLE = 'Nom du produit';
	var $_PHPSHOP_PRODUCT_PRICE = 'Prix';
	var $_PHPSHOP_PRODUCT_TOTAL_PRICE = 'Taxes incluses';
	...
	var $_PHPSHOP_ADD_SHIPTO_1 = '<p><b><font color=red>Important</font></b><br>SVP, ajoutez une nouvelle adresse de livraison si elle n\'est pas dans la liste ci-dessous et cliquez >>suivant>>.</p>';
	var $_PHPSHOP_ADD_SHIPTO_2 = 'Adresse d\'expédition';
	var $_PHPSHOP_ORDER_DELIVERY = 'Livraison';
	var $_PHPSHOP_NO_SEARCH_RESULT = 'Votre recherche n\'a renvoyé aucun résultat.<BR>';
	var $_PHPSHOP_PRICE_LABEL = 'Prix: ';
	var $_PHPSHOP_ORDER_BUTTON_LABEL = 'Ajouter au panier';
	...
	var $_PHPSHOP_EMAIL_SENDTO = 'Un courriel de confirmation vous a été envoyé à ';
	...
	var $_PHPSHOP_REMINDER_TITLE = 'Service de rappel';
	var $_PHPSHOP_REMINDER_NEW = 'Nouveau rappel';
	var $_PHPSHOP_REMINDER_EDIT = 'Editer le rappel';
	var $_PHPSHOP_REMINDER_ACCOUNT = 'Rappel Personnel:';
	var $_PHPSHOP_REMINDER_TITLE1 = 'Mémoriser une occasion spéciale';
	var $_PHPSHOP_REMINDER_TITLE2 = 'L\'anniversaire de votre mere, L\'anniversaire de votre belle-mere, L\'anniversaire de vos parents... Des occasions annuelles aux événements occasionnels, Chaque année est emballée avec les dates spéciales pour que vous vous en rappeliez - Ce n\'est pas une tache facile quand les exigences de la vie vous obligent a être toujours occupé. Employez notre service de rappel par courriel pour vous aider à se rappeler de toutes les occasions spéciales.';
	var $_PHPSHOP_REMINDER_TITLE3 = 'Notre service de rappel vous aide a... ';
	var $_PHPSHOP_REMINDER_TITLE4 = '<ul><li> Demandez les courriels de rappel pour autant d\'occasions comme vous voudrez <br /></li><li> Recevez les rappels le jour quand vous le demandez, ainsi vous aurez toujours le temps pour envoyer votre cadeau sans retard <br /></li><li> Nos expertes en cadeaux vous donneront les recommandations appropriées pour chaque occasion </li></ul>';
	var $_PHPSHOP_REMINDER_INFO = 'Liste De Service De Rappel ';
	var $_PHPSHOP_REMINDER_LIST1 = 'Personne:  ';
	var $_PHPSHOP_REMINDER_LIST1_1 = 'Prénom du Destinataire: ';
	var $_PHPSHOP_REMINDER_LIST1_2 = 'Nom:  ';
	var $_PHPSHOP_REMINDER_LIST2 = 'Courriel:  ';
	var $_PHPSHOP_REMINDER_LIST3 = 'Mois: ';
	var $_PHPSHOP_REMINDER_LIST4 = 'Date: ';
	var $_PHPSHOP_REMINDER_LIST5 = 'Jour ';
	var $_PHPSHOP_REMINDER_LIST6 = 'Occasion:  ';
	var $_PHPSHOP_REMINDER_LIST7 = 'Message:  ';
	var $_PHPSHOP_REMINDER_NO = 'Aucuns rappels à montrer';
	var $_PHPSHOP_REGISTRATION_FORM_SEND1 = 'Une fois seulement ';
	var $_PHPSHOP_REGISTRATION_FORM_SEND2 = 'Annuellement';
	var $_PHPSHOP_REMINDER_ERROR = 'ERREUR: Le prénom OU le courriel OU le Message est vide! ';
	var $_PHPSHOP_REMINDER_MSG = 'Envoyer un courriel!';
	var $_PHPSHOP_REGISTRATION_FORM_RD1 = '';
	var $_PHPSHOP_REMINDER_THANK = '<center>Merci pour votre enregistration avex le service de rappel de Bloomex.<br/> Vous recevrez un courriel de rappel 3 jour d\'avance.</center>';
	var $_PHPSHOP_ADMIN_MOD = 'Administration du Site';
	...
	var $_PHPSHOP_USER_FORM_NO_SHIPPING_ADDRESSES = 'Aucun adresse de livraison.';
	var $_PHPSHOP_USER_FORM_ADDRESS_LABEL = 'Nom de l\'adresse';
	var $_PHPSHOP_USER_FORM_FIRST_NAME = 'Prénom';
	var $_PHPSHOP_USER_FORM_LAST_NAME = 'Nom de Famille';
	var $_PHPSHOP_USER_FORM_MIDDLE_NAME = '2ème prénom';
	var $_PHPSHOP_USER_FORM_TITLE = 'Fonction';
	...
	var $_PHPSHOP_USER_FORM_CUSTOMER_NUMBER = 'Numéro de client / ID';
 ...
 var $_PHPSHOP_USER_FORM_SUITE = 'Suite';
        var $_PHPSHOP_USER_FORM_STREET_NUMBER = 'Numéro de rue';
        var $_PHPSHOP_USER_FORM_STREET_NAME = 'Nom de la rue';   
	...
	var $_PHPSHOP_USER_FORM_PHONE2 = 'Téléphone (cellulaire)';
	var $_PHPSHOP_USER_FORM_PHONE3 = 'Cellulaire';
	var $_PHPSHOP_USER_FORM_FAX = 'Fax';
	var $_PHPSHOP_USER_FORM_EMAIL = 'Courriel';
	var $_PHPSHOP_USER_FORM_EMAIL2 = 'Courriel Secondaire';
	var $_PHPSHOP_USER_FORM_OCCASION = 'Occasion';
	var $_PHPSHOP_USER_FORM_DELIVERYDATE = 'Date De Livraison';
	var $_PHPSHOP_USER_FORM_CARDMESSAGE = 'Message sur carte postale';
  ...
  var $_PHPSHOP_SUITE = 'Suite/Apt #';
        var $_PHPSHOP_STREET_NUMBER = 'Numéro de rue';
        var $_PHPSHOP_STREET_NAME = 'Nom de la rue';   
	var $_PHPSHOP_CONTINUE = 'Continuer';
	var $_PHPSHOP_EMPTY_CART = '<p><b>Votre panier est actuellement vide.</b><p><font size=1><i>Si vous avez des difficultés, SVP composez le 1-800-905-147 pour commandez par téléphone</i></font>';
	...
	var $_PHPSHOP_ORDER_LIST_WAREHOUSE = 'Notifier l\'Entrepôt?';
	var $_PHPSHOP_ORDER_LIST_PRIORITY = 'Priorité';
	...
	var $_PHPSHOP_ORDER_PRINT_CUST_SHIPPING_LBL = 'Information d\'Expédition';
        var $_PHPSHOP_ORDER_PRINT_CUST_SHIPPING_LBL_ADDR = 'Une seule adresse de livraison peut être sélectionné par commande. Pour plusieurs points de livraison, s\'il vous plaît communiquer avec le Service à la clientèle au 1-800-905-147';
   ...
   var $_PHPSHOP_ORDER_PRINT_SUITE = 'Suite/Apt #';
        var $_PHPSHOP_ORDER_PRINT_STREET_NUMBER = 'Numéro de rue';
        var $_PHPSHOP_ORDER_PRINT_STREET_NAME = 'Nom de la rue';   
	...
	var $_PHPSHOP_ORDER_PRINT_PHONE2 = 'Téléphone (cellulaire) ';
	var $_PHPSHOP_ORDER_PRINT_PHONE3 = 'Cellulaire';
	var $_PHPSHOP_ORDER_PRINT_FAX = 'Fax';
	var $_PHPSHOP_ORDER_PRINT_EMAIL = 'Courriel';
	...
	var $_PHPSHOP_ORDER_PRIORITY = 'Priorité';
	var $_PHPSHOP_ORDER_WAREHOUSE = 'Entrepôt';
	var $_PHPSHOP_ORDER_PRIORYTY = 'Priorité';
	var $_PHPSHOP_ORDER_WAREHOUSE_NOTIFY = 'Notifier l\'Entrepôt';
	var $_PHPSHOP_ORDER_PRIORITY_NAME = 'Nom de Priorité';
	var $_PHPSHOP_ORDER_WAREHOUSE_NAME = 'Nom de l\'Entrepôt';
	var $_PHPSHOP_ORDER_WAREHOUSE_EMAIL = 'Courriel de l\'Entrepôt';
	var $_PHPSHOP_ORDER_PRIORITY_SUBLIST_MNU = 'Priorité de la Commande';
	var $_PHPSHOP_ORDER_WAREHOUSE_SUBLIST_MNU = 'Entrepôt de la Commande';
	var $_PHPSHOP_ORDER_OCCASIONS_MNU = 'Occasions';
	var $_PHPSHOP_ORDER_HOWFIND_MNU = 'Referrers';
	var $_PHPSHOP_ORDER_HOWFIND_NAME = 'Nom du Referrers';
	var $_PHPSHOP_ORDER_OCCASIONS_NAME = 'Nom de l\'Occasions';
	var $_PHPSHOP_ORDER_OCCASIONS_LISTMNU = 'Liste d\'Occasion';
	var $_PHPSHOP_ORDER_OCCASIONS_ADDMNU = 'Ajouter un Occasion';
	var $_PHPSHOP_ORDER_HOW_MNU = 'Comment avez vous trouvé Bloomex';
	var $_PHPSHOP_ORDER_HOW_LISTMNU = 'Liste de Referrers';
	var $_PHPSHOP_ORDER_HOW_ADDMNU = 'Ajouter un Referrer';
	var $_PHPSHOP_ORDER_PRIORITY_LIST_MNU = 'Sorte de Priorité';
	var $_PHPSHOP_ORDER_WAREHOUSE_LIST_MNU = 'Sorte d\'Entrepôt';
	...
	var $_PHPSHOP_ORDER_OCCATION_FORM_LBL = 'Occasion de la Commande';
	...
	var $_PHPSHOP_PRODUCT_LIST_PRICE = 'Prix';
	var $_PHPSHOP_PRODUCT_LIST_PUBLISH = 'Publier';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE = 'Rechercher un produit';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_TYPE_PRODUCT = 'modifié';
	var $_PHPSHOP_PRODUCT_LIST_SEARCH_BY_DATE_TYPE_PRICE = 'prix modifié';
	...
	var $_PHPSHOP_PRODUCT_FORM_RP = 'Produit semblable dans le panier d\'achat?';
	...
	var $_PHPSHOP_PRODUCT_FORM_UNIT_DEFAULT = 'morceaux';
	...
	var $_PHPSHOP_RB_STATUS_ORDERS = ' Statut de commande';
	var $_PHPSHOP_RB_SHIPPING = 'Total d\'expédition ';
	var $_PHPSHOP_RB_TAX = 'Total des taxes';
	var $_PHPSHOP_RB_SUBREVENUE = 'Sous total';
	...
	var $_PHPSHOP_RB_STATUS_ORDER = 'Changer le statut de la commande ';
	...
	var $_PHPSHOP_SHOPPER_FORM_LAST_NAME = 'Nom de Famille';
   ...
   var $_PHPSHOP_SHOPPER_FORM_SUITE = 'Suite/Apt #';
        var $_PHPSHOP_SHOPPER_FORM_STREET_NUMBER = 'Numéro de rue';
        var $_PHPSHOP_SHOPPER_FORM_STREET_NAME = 'Nom de la rue';   
	...
	var $_PHPSHOP_SHOPPER_FORM_PHONE2 = 'Téléphone (autre)';
	var $_PHPSHOP_SHOPPER_FORM_PHONE3 = 'Cellulaire';
	var $_PHPSHOP_SHOPPER_FORM_RMAIL = 'Courriel du destinataire';
	var $_PHPSHOP_SHOPPER_FORM_OCCASION = 'Occasion';
	var $_PHPSHOP_SHOPPER_FORM_CARD_MESSAGE = 'Message sur la carte';
	var $_PHPSHOP_SHOPPER_FORM_SIGN = 'Signature';
	var $_PHPSHOP_SHOPPER_FORM_INSTRUCTIONS = 'Instructions spéciales et commentaires';
	var $_PHPSHOP_SHOPPER_FORM_FIND = 'Comment avez-vous trouvé Bloomex?';
	var $_PHPSHOP_SHOPPER_FORM_EVE_PHONE = 'Téléphone (soir)';
	var $_PHPSHOP_SHOPPER_FORM_FAX = 'Fax';
	var $_PHPSHOP_SHOPPER_FORM_EMAIL = 'Courriel';
	var $_PHPSHOP_SHOPPER_FORM_EMAIL2 = 'Courriel secondaire';
	var $_PHPSHOP_SHOPPER_FORM_EMAIL3 = 'Courriel du destinataire';
   ...
   var $_PHPSHOP_STORE_FORM_SUITE = 'Suite';
        var $_PHPSHOP_STORE_FORM_STREET_NUMBER = 'Numéro de rue';
        var $_PHPSHOP_STORE_FORM_STREET_NAME = 'Nom de la rue';   
	...
	var $_PHPSHOP_USER_FORM_REMINDER = 'Rappels';
	var $_PHPSHOP_REMINDER_LIST_MNU = 'Liste de rappels';
	var $_PHPSHOP_REMINDER_LIST_ADD = 'Ajouter le rappel';
	var $_PHPSHOP_REMINDER_LIST_EDIT = 'éditer le rappel';
	var $_PHPSHOP_WAREHOUSE_MOD = 'L\'Entrepôt ';
	var $_PHPSHOP_WAREHOUSE_RATE = 'Taxes';
	var $_PHPSHOP_WAREHOUSE_LIST_MNU = 'Les Entrepôts';
	var $_PHPSHOP_WAREHOUSE_LIST_LBL = 'Les Entrepôts';
	var $_PHPSHOP_WAREHOUSE_LIST_LBL_AMOUNT_TIP = 'Liste Prioritaire';
	var $_PHPSHOP_WAREHOUSE_LIST_NAME = 'Nom de l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_LIST_NAME_AMOUNT_TIP = 'Nom de l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_LIST_CODE = 'Code de l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_LIST_CODE_AMOUNT_TIP = 'Code de l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_LIST_EMAIL = 'Courriel de l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_LIST_EMAIL_AMOUNT_TIP = 'Courriel de l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_FORM_MNU = 'Ajouter l\'entrepôt ';
	var $_PHPSHOP_WAREHOUSE_FORM_LBL = 'L\'Information sur l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_FORM_CODE = 'Code de l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_FORM_NAME = 'Nom de l\'entrepôt';
	var $_PHPSHOP_WAREHOUSE_FORM_LIST = 'Montrer la commande';
	var $_PHPSHOP_WAREHOUSE_FORM_EMAIL = 'Courriel de l\'entrepôt';
	var $_PHPSHOP_PRIORITY_MOD = 'Priorité';
  ...
  var $_PHPSHOP_VENDOR_FORM_SUITE = 'Suite';
        var $_PHPSHOP_VENDOR_FORM_STREET_NUMBER = 'Numéro de rue';
        var $_PHPSHOP_VENDOR_FORM_STREET_NAME = 'Nom de la rue';   
	...
	var $_PHPSHOP_VENDOR_FORM_LAST_NAME = 'Nom de famille';
	...
	var $_PHPSHOP_VENDOR_FORM_EMAIL = 'Courriel';
	...
	var $_PHPSHOP_MANUFACTURER_FORM_EMAIL = 'Courriel';
   ...
   var $_PHPSHOP_CHECKOUT_CONF_SUITE = 'Suite/Apt #';
        var $_PHPSHOP_CHECKOUT_CONF_STREET_NUMBER = 'Numéro de rue';
        var $_PHPSHOP_CHECKOUT_CONF_STREET_NAME = 'Nom de la rue';   
  var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_SUITE = 'Suite/Apt #';
        var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_STREET_NUMBER = 'Numéro de rue';
        var $_PHPSHOP_CHECKOUT_CONF_SHIPINFO_STREET_NAME = 'Nom de la rue';   
	var $_PHPSHOP_CHECKOUT_CONF_PHONE = 'Téléphone';
	var $_PHPSHOP_CHECKOUT_CONF_FAX = 'Fax';
	var $_PHPSHOP_CHECKOUT_CONF_EMAIL = 'Courriel';
	...
	var $_PHPSHOP_ACCOUNT_ORDER_TITLE = 'Information de Commande';
	var $_PHPSHOP_MODULES = 'Modules';
	var $_PHPSHOP_FUNCTIONS = 'Fonctions';
	var $_PHPSHOP_SPECIAL_PRODUCTS = 'Produits spéciaux';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_NOTE = '<b>Message sur carte:</b>';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_OCCASION = '<b>Occasion</b>';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_SIGNATURE = '<b>SignatureSignature</b>';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE = 'Date De Livraison';
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_NOTE = 'Remarque Client';
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_COMMENTS = '<b>Instructions spéciales et commentaires</b>';
	var $_PHPSHOP_ORDER_PRINT_FIND_US = 'Comment avez-vous trouvé Bloomex';
	...
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1 = 'Merci de votre confiance.  Les informations concernant votre commande se trouvent ci-dessous.';
	var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER2 = 'Merci de votre confiance.';
	...
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION1 = 'Anniversaire';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION2 = 'Fête d\'anniversaire';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION3 = 'Félicitations';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION4 = 'Juste Parce que...';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION5 = 'Amour';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION6 = 'Nouveau né';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION7 = 'Funérailles';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION8 = 'Remerciements';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION9 = 'Mariage';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION10 = 'Excuses';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION11 = 'Fêtes';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION12 = 'Me rappeler';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION13 = 'Semaine d\'assistance administrative';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION14 = 'Remise des diplômes';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION15 = 'La pâque juive';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION16 = 'Jour de St Valentin';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION17 = 'Noël';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION18 = 'Pâque';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION19 = 'Fête des pères';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION20 = 'D\'action de grâces';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION21 = 'Fête des mères';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION22 = 'Le nouveau Jour de Déchirure';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION23 = 'Jour du Canada';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION24 = 'Halloween';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION25 = 'Hanukkah';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION26 = 'La pâque juive';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION27 = 'Rosh Hashanah';
	var $_PHPSHOP_REGISTRATION_FORM_OCCASION28 = 'Yom Kippur';
	var $_PHPSHOP_REGISTRATION_FORM_FINDUS1 = 'Moteur de recherche';
	var $_PHPSHOP_REGISTRATION_FORM_FINDUS2 = 'Client habituel';
	var $_PHPSHOP_REGISTRATION_FORM_FINDUS3 = 'Emailing';
	var $_PHPSHOP_REGISTRATION_FORM_FINDUS4 = 'Publicité par courrier individuel';
	var $_PHPSHOP_REGISTRATION_FORM_FINDUS5 = 'Radio';
	var $_PHPSHOP_REGISTRATION_FORM_FINDUS6 = 'Télévision';
	var $_PHPSHOP_REGISTRATION_FORM_FINDUS7 = 'de Bouche-à-Oreilles';
	var $_PHPSHOP_REGISTRATION_FORM_FINDUS8 = 'Moteur de recherche';
	...
	var $_PHPSHOP_AFFILIATE_EMAIL_MNU = 'Courriel Affilié';
	var $_PHPSHOP_AFFILIATE_EMAIL_LBL = 'Courriel Affilié';
	var $_PHPSHOP_AFFILIATE_EMAIL_WHO = 'A qui envoyer le courriel(* = TOUS)';
	var $_PHPSHOP_AFFILIATE_EMAIL_CONTENT = 'Votre Courriel';
	...
	var $_PHPSHOP_WAITING_LIST_MESSAGE = 'Veuillez saisir votre adresse courriel pour être prévenu(e) dès que ce produit sera de nouveau disponible en stock. 
                                        Votre adresse courriel ne sera en aucune manière cédée, vendue ou partagée de quelques manière que ce soit autre 
	...
	var $_PHPSHOP_REVIEW_COMMENT = 'Veuillez saisir un (court) commentaire....';
	var $_PHPSHOP_REVIEW_COUNT = 'Caractères saisis: ';
	var $_PHPSHOP_REVIEW_SUBMIT = 'Poster Commentaire';
	  var $_PHPSHOP_ORDER_BANNER = 'send_more_flowers_now_fr';
	...
	var $_PHPSHOP_CONTINUE_SHOPPING = 'Continuer magasiner';
	...
	var $_PHPSHOP_ORDER_STATUS_CHANGE_PRIORITY = 'Nouveau Priorité:';
	...
	var $_PHPSHOP_COUPON_REDEEMED = 'Chèque Boutique dépensé ! Merci.';
        var $_PHPSHOP_COUPON_ENTER_HERE_CLICK = '<b><i>Cliquez</i> <a href=\'#\' onclick=\'showCodeBox();return false;\' >ici pour</a> <i>entrer le code</i></b>';
	var $_PHPSHOP_COUPON_ENTER_HERE = 'Si vous avez un code de rabais, veuillez le saisir ci-dessous:';
	...
	var $_PHPSHOP_RELATED_PRODUCTS_HEADING = 'Ne pas oublier ces ajouts populaires!';
	...
	var $_PHPSHOP_ORDER_EDIT = 'Changer la Commande';
	var $_PHPSHOP_ORDERMESSAGE_EDIT = 'Changer le message sur la carte';
	var $_PHPSHOP_ORDER_EDIT_ADD = 'AJOUTER';
	var $_PHPSHOP_ORDER_EDIT_ADD_PRODUCT = 'AJOUTER UN PRODUIT';
	var $_PHPSHOP_ORDER_EDIT_EDIT_ORDER = 'Changer la commande';
	var $_PHPSHOP_ORDER_EDIT_ERROR_QUANTITY_MUST_BE_HIGHER_THAN_0 = 'QUANTITE DOIT ETRE PLUS QUE 0';
	var $_PHPSHOP_ORDER_EDIT_PRODUCT_ADDED = 'Produit AJOUTER';
	var $_PHPSHOP_ORDER_EDIT_PRODUCT_DELETED = 'PRODUIT SUPRIMER';
	var $_PHPSHOP_ORDER_EDIT_QUANTITY_UPDATED = 'Quantité Changée';
	var $_PHPSHOP_ORDER_EDIT_RETURN_PARENTS = 'Retour original';
...
When not checked, price labels look just as usual: <strong>Price: $xx.xx</strong>';
	...
	var $_PHPSHOP_USER_SEND_REGISTRATION_DETAILS = 'Salut %s,

Merci pour votre enregistration chez %s. Votre compte a été crée.
Vous pouvez connecter à %s en utilisant le nom d\'utilisateur et mot de passe:
...
Afterwards you can select it here.';
	var $_VM_LEGALINFO_SHORTTEXT = 'Attention utilisateurs de Hotmail
Pour assurer que l\'information de votre commande n\'est pas envoye dans votre boite de Pourriel, nous suggerons que vous ajoutez bloomex.ca a votre liste de site reconnue. Si vous ne savez pas comment ajouter un site a la liste, regardez <a href="http://209.85.105.17/movies/hotmail/"ce video (35sec)</a> (ouvre dans une fenetre nouvelle)  
Attention Client(e):
S\'il-vous-plait lire notre politique de remboursement pour plus d\'information au sujet de notre garantie de satisfaction. <a href="http://209.85.105.17/index.php?option=com_content&task=view&id=29&Itemid=220">Politique de Remboursement</a>.  
';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_0 = 'Merci pour votre commande avec Bloomex. C\'est très appreciée.';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_4 = 'Ceci veut dire: <br /> 1.l\'adresse de livraison est vérifiée <br /> 2. le payment a été accepté <br /> 3. production est schédulé  <br /> 4. la route de livraison est décidé en accord avec notre politique de livraison et vos instructions.<br />';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_5 = 'Si vous avez des questions composez le:';
	var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_6 = 'Voulez-vous recevoir un rabais sur votre commande? Envoyez un courriel au sujet de Bloomex à trois de vos amis(es). Cliquez ici ( <a href="http://bloomex.ca/index.php?option=com_content&task=view&id=30&Itemid=220">http://bloomex.ca/index.php?option=com_content&task=view&id=30&Itemid=220) </a>pour plus de détails.';
	var $_PHPSHOP_CHECKOUT_PAYMENT_CM = 'Vous auriez la chance de choisir la date de livraison et le message sur la carte à la prochaine étape.';
        
	
	var $_VM_EDIT 									=  'Modifier';
	var $_VM_CLOSE									=  'Fermer';
	var $_VM_DELETE 								=  'Supprimer';
	var $_VM_DELETING 								=  'Suppression...';
	var $_VM_UPDATING 								=  'Mise à jour...';
	var $_VM_ADD_ADDRESS							=  'Ajouter une adresse';
 	var $_VM_UPDATE_ADDRESS							=  'Modifier l\'adresse';
	var $_VM_ADD_PRODUCT_SUCCESSFUL 				=  'Le produit a été ajouté au panier';
	var $_VM_ADD_PRODUCT_UNSUCCESSFUL 				=  "Produit n\'a pas été ajouté au panier";
	var $_VM_CONFIRM_DELETE		 					=  "Voulez-vous supprimer cet élément?";
	var $_VM_DELETE_SUCCESSFUL	 					=  "Produit Adresse a été supprimé avec succès!";
	var $_VM_DELETE_UNSUCCESSFUL	 				=  "Product address was not deleted!";
	var $_VM_CONFIRM_QUANTITY		 				=  "Produit adresse n\'a pas été supprimé!";	
	var $_VM_CONFIRM_COUPON_CODE	 				=  'S\'il vous plaît entrez le code coupon!';
	var $_VM_UPDATE_CART_ITEM_SUCCESSFUL			=  "Panier articles ont été mis à jour avec succès!";
	var $_VM_UPDATE_CART_ITEM_UNSUCCESSFUL			=  "Panier articles n\'ont pas été mis à jour avec succès!";
	
	var $_VM_CONFIRM_FIRST_NAME						=  "S\'il vous plaît entrer Prénom!";
	var $_VM_CONFIRM_LAST_NAME						=  "S\'il vous plaît entrez le nom d\'Dernière!";
	var $_VM_CONFIRM_ADDRESS						=  "S\'il vous plaît entrez l\'adresse!";
	var $_VM_CONFIRM_CITY							=  "S\'il vous plaît entrez dans la ville!";
	var $_VM_CONFIRM_ZIP_CODE						=  "S\'il vous plaît entrer le code postal Code!";
	var $_VM_CONFIRM_VALID_ZIP_CODE					=  "S\'il vous plaît entrer votre code postal again! \ N Exemple: K2E 7X3 (LDL DLD. Où L = lettre, D = nombre)";
	var $_VM_CONFIRM_COUNTRY						=  "S\'il vous plaît sélectionnez Pays!";
	var $_VM_CONFIRM_STATE							=  "S\'il vous plaît entrez Etat!";
	var $_VM_CONFIRM_PHONE_NUMBER					=  "Please enter Phone Number!";
	var $_VM_CONFIRM_EMAIL							=  "S\'il vous plaît entrer Numéro de téléphone!";
	var $_VM_CONFIRM_ADD_NICKNAME					=  "S\'il vous plaît entrez l\'adresse e!";
	
	var $_VM_DELETING_DELIVER_INFO					=  "Suppression d\'offrir de l\'information...";
	var $_VM_DELETE_DELIVER_INFO_SUCCESSFUL			=  "Adresse de livraison a été supprimé avec succès!";
	var $_VM_DELETE_DELIVER_INFO_UNSUCCESSFUL		=  "Adresse de livraison n\'a pas été supprimé avec succès!";
	var $_VM_UPDATING_DELIVER_INFO					=  "Mise à jour de fournir des informations...";
	var $_VM_UPDATE_DELIVER_INFO_SUCCESSFUL			=  "Adresse de livraison a été mis à jour avec succès!";
	var $_VM_UPDATE_DELIVER_INFO_UNSUCCESSFUL		=  "Adresse de livraison n\'a pas été mis à jour avec succès";
	var $_VM_ADD_DELIVER_INFO_SUCCESSFUL			=  "Adresse de livraison a été ajouté avec succès!";
	var $_VM_ADD_DELIVER_INFO_UNSUCCESSFUL			=  "Adresse de livraison n\'a pas été ajouté avec succès!";
	var $_VM_LOAD_DELIVER_INFO_FORM_UNSUCCESSFUL	=  "Modifier la charge de fournir des informations sous une mauvaise forme";
	
	var $_VM_UPDATING_BILLING_INFO					=  "Mise à jour des informations de facturation...";
	var $_VM_UPDATE_BILLING_INFO_SUCCESSFUL			=  "Les informations de facturation a été mis à jour avec succès!";
	var $_VM_UPDATE_BILLING_INFO_UNSUCCESSFUL		=  "Les informations de facturation n\'a pas été mis à jour avec succès!";
	
	var $_VM_ADDRESS 								=  'Adresse';
   var $_VM_SUITE                                                                  = 'Suite/Apt #';
        var $_VM_STREET_NUMBER                                                          = 'Numéro de rue';
       var $_VM_STREET_NAME                                                            = 'Nom de la rue';   
	var $_VM_ZIPCODE 								=  'Code postal';
	var $_VM_PHONE 									=  'Téléphone';
	var $_VM_FAX	 								=  'Fax';
	
	var $_VM_DELIVERY 								=  'Mode de livraison';
	var $_PHPSHOP_CHECKOUT_CUSTOMER_DELIVERYDATE2 	=  '<b>Date de livraison Date<font color=red>*</font></b>';
        var $_PHPSHOP_SELECT_DELIVERY_DATE = "Choisir la date de Livraison";
	var $_VM_BLOOMEX_TIME						 	=  'Bloomex temps est:';
	var $_PHPSHOP_ORDER_PRINT_FIND_US_2 			= '<b>Je suis intéressé à recevoir les promotions spéciales de Bloomex:<b>';
	var $_VM_REQUIRED						 		=  'Nécessaire';
	var $_VM_CHECKOUT_CARD_LABEL			 		=  'Visa, Master Card';
    var $_VM_CHECKOUT_CARD_LABEL2			 		=  'Sélectionnez cette option UNIQUEMENT si votre carte de crédit a été refusée';
	var $_VM_CREDIT_CARD_TYPE				 		=  'Type de carte de crédit';
	var $_VM_NAME_ON_CARD					 		=  'Nom sur la carte';
	var $_VM_CREDIT_CARD_NUMBER			 			=  'Numéro de carte de crédit';
	var $_VM_CREDIT_CARD_SECURITY_CODE		 		=  'Carte de crédit Code de sécurité';
	var $_VM_EXPIRY_MONTH					 		=  'Mois d\'expiration';     
	var $_VM_CREDIT_CARD_NOTE				 		=  'Attention <br/>
														Nom sur la carte: exactement comme cela semble sur votre carte <br/>
														Credit Card number: 16 (VISA, MC) ou 15 (AMEX) chiffres, sans espaces <br/>';
	var $_VM_ORDER_PRICE_DETAIL						=  'Commande Prix Détail';
	var $_VM_TOTAL_ITEMS_PRICE						=  'Total Items Prix:';
	var $_VM_TOTAL_ITEMS_TAX						=  'Éléments fiscaux:';
	var $_VM_DELIVERY_FEE							=  'Frais de livraison:';
	var $_VM_DELIVERY_SURCHARGE						=  'Distribution Supplément:';
	var $_VM_TOTAL_DELIVERY							=  'Total de livraison:';
	var $_VM_TOTAL_PRICE							=  'Prix total:';
	var $_VM_CALCULATE_BUTTON						=  'Calculer Total commande';
    var $_VM_SUBMIT_BUTTON							=  'Soumettre la commande';
    
    var $_VM_CANNOT_DELIVER							=  'Nous ne pouvons pas livrer à cet endroit s\'il vous plaît sélectionner un autre emplacement';
	...
	var $_PHPSHOP_PRODUCT_ORDER_DEFAULT_MODIFIED_LBL = 'Default sorting';
        var $_PHPSHOP_PRODUCT_NPRICE 	= 'Bloomex Prix';
        var $_PHPSHOP_PRODUCT_RPRICE 	= 'Prix courant';
	var $_PHPSHOP_PRODUCT_SPRICE 	= 'PRIX DE VENTE';
	var $_PHPSHOP_PRODUCT_SVPRICE 	= 'Vous économisez';
	
	var $_VM_VALIDATING_CART 	= 'Your cart is calculating...';
	var $_VM_VALIDATING_CART2 	= 'Votre panier est en cours de validation...';
	var $_VM_VALIDATING_CART3 	= 'Your cart was refreshed successfully. Please click "Submit Order" again ...';
        
    var $_PHPSHOP_PROCEED_CHECKOUT = 'command';
    var $_PHPSHOP_PD_STEP1_TITLE = 'Choisir la taille';
    var $_PHPSHOP_PD_STEP1_TITLE2 = 'Choisir la taille';
    var $_PHPSHOP_PD_STEP2_TITLE = 'Touches Supplémentaires';
    var $_PHPSHOP_PD_STEP3_TITLE = 'Ajouter les produits selectionnés au panier et le calendrier de livraison';
    var $_PHPSHOP_PD_ADDTOCART = 'Ajouter au panier';
    var $_PHPSHOP_PD_RATING1 = 'sur la base de';
    var $_PHPSHOP_PD_RATING2 = 'Avis des clients';
    var $_PHPSHOP_PD_REGULARSIZE = 'La norme';
    var $_PHPSHOP_PD_DELUXESIZE = 'De luxe';
    var $_PHPSHOP_PD_SUPERSIZESIZE = 'Supersize';
    
    var $_VM_CORPORATE_DISCOUNT = 'Réduction d\'entreprise';
    var $_VM_COUPON_DISCOUNT = 'Remise de coupon';
    var $_VM_TAXES = 'Les taxes';
    var $_VM_BLOOMEX_BUCKS = 'Échangez des dollars Bloomex';
    var $_VM_DONATION = 'Donation';
    var $_VM_DONATION_LABEL = 'Je voudrais faire un don de {amount} to {name}';
    
    var $_FLOWER_DELIVERY = 'Livraison de fleurs';
    var $_BASKET_DELIVERY = 'Livraison de paniers';
    var $_SYMPATHY_DELIVERY = 'Fleurs de sympathie';
}
