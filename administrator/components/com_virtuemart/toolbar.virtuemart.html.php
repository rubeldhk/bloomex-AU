...
$vmIcons['switch'] = $mosConfig_live_site."/administrator/images/switch.png";
$vmIcons['switch2'] = $mosConfig_live_site."/administrator/images/switch_f2.png";
...
class MENU_virtuemart {
	...
	*/
    function FORMS_MENU_SAVE_CANCEL() {     
        ...
        $editor1_array = Array(
            //'product.product_form' => 'product_desc', 
            'shopper.shopper_group_form' => 'shopper_group_desc',
            //'product.product_category_form' => 'category_description', 
            'manufacturer.manufacturer_form' => 'mf_desc',
	...
	function LISTS_SPECIAL_TASKS( $page ) {
		...
		switch( $page ) {
			...
			case "product.product_list":
				...
				vmMenuBar::custom('sold_products','product.product_list',$vmIcons['switch'], $vmIcons['switch2'],"&nbsp;Sold Out");
				vmMenuBar::custom('in_stock','product.product_list',$vmIcons['switch'], $vmIcons['switch2'],"&nbsp;In Stock");


				vmMenuBar::customicon('upload_list','parse.png','parse.png','Update Products',false,'',false);
				vmMenuBar::customicon('upload_desc_list','parse.png','parse.png','Update Product Desc',false,'',false);
