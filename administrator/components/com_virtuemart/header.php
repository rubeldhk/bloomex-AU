             ...
             switch($mod[$i]) {
                ...
                case "admin": 
                    ...
                    [null,'<?php echo $lbl ?>',null,null,'<?php echo $lbl ?>',
                        ...
                        <?php } ?>
                        _cmSplit,
                        ['<img src="<?php echo $my_path ?>sections.png" />','<?php echo $VM_LANG->_PHPSHOP_USER_FORM_REMINDER ?>',null,null,'<?php echo $VM_LANG->_PHPSHOP_USER_FORM_REMINDER ?>',
                            ['<img src="<?php echo $my_path ?>content.png" />','<?php echo $VM_LANG->_PHPSHOP_REMINDER_LIST_MNU ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=admin.reminder_list") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_REMINDER_LIST_MNU ?>'],
                        ]
                         <?php break;
               ...
               // case "reportbasic":
                 //   if ($i != 0) {
                   // ?> ], _cmSplit, <?php 
                   // } ?>
                   // [null,'<?php echo $lbl ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=reportbasic.index&show=ALL") ?>',null,'<?php echo $lbl ?>'
                ...
                case "warehouse":
                    ...
                    [null,'<?php echo $lbl ?>',null,null,'<?php echo $lbl ?>',
                        ['<img src="<?php echo $my_path ?>content.png" />','<?php echo $VM_LANG->_PHPSHOP_WAREHOUSE_LIST_MNU ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=warehouse.warehouse_list") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_WAREHOUSE_LIST_MNU ?>'],
                        ['<img src="<?php echo $my_path ?>edit.png" />','<?php echo $VM_LANG->_PHPSHOP_WAREHOUSE_FORM_MNU ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=warehouse.warehouse_form") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_WAREHOUSE_FORM_MNU ?>'],
                        _cmSplit,
                        ['<img src="<?php echo $my_path ?>content.png" />','<?php echo $VM_LANG->_PHPSHOP_PRIORITY_LIST_MNU ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=priority.priority_list") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_PRIORITY_LIST_MNU ?>'],
                        ['<img src="<?php echo $my_path ?>edit.png" />','<?php echo $VM_LANG->_PHPSHOP_PRIORITY_FORM_MNU ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=priority.priority_form") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_PRIORITY_FORM_MNU ?>']
                ...
                case "order":
                    ...
                    [null,'<?php echo $lbl ?>',null,null,'<?php echo $lbl ?>',
                        ...
                        ['<img src="<?php echo $my_path ?>sections.png" />','<?php echo $VM_LANG->_PHPSHOP_ORDER_OCCATION_LIST_MNU ?>',null,null,'<?php echo $VM_LANG->_PHPSHOP_ORDER_OCCATION_LIST_MNU ?>',
                            ['<img src="<?php echo $my_path ?>content.png" />','<?php echo $VM_LANG->_PHPSHOP_ORDER_OCCATION_LIST_MNU ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=order.order_occasion_list") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_ORDER_OCCATION_LIST_MNU ?>'],
                            ['<img src="<?php echo $my_path ?>edit.png" />','<?php echo $VM_LANG->_PHPSHOP_ORDER_OCCATION_FORM_MNU ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=order.order_occasion_form") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_ORDER_OCCATION_FORM_MNU ?>']
                        ],
                        ['<img src="<?php echo $my_path ?>sections.png" />','<?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_PO_MARK ?>',null,null,'<?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_PO_MARK ?>',
                            ['<img src="<?php echo $my_path ?>content.png" />','<?php echo $VM_LANG->_PHPSHOP_ORDER_MARKS_LIST_MNU ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=order.order_mark_list") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_ORDER_MARKS_LIST_MNU ?>'],
                            ['<img src="<?php echo $my_path ?>edit.png" />','<?php echo $VM_LANG->_PHPSHOP_ORDER_MARK_FORM_MNU  ?>','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=order.order_mark_form") ?>',null,'<?php echo $VM_LANG->_PHPSHOP_ORDER_MARK_FORM_MNU  ?>']
                        ],
                        <?php break;
