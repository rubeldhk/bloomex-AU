...
function showProFlower( $option ) {
	...
	$query = "SELECT COUNT(*) AS total FROM #__vm_order_proflower AS PF INNER JOIN #__vm_orders AS O ON PF.order_id = O.order_id  $sWhere ";
	...
	//echo $query."<br/><br/><br/>$total=======<br/><br/><br/>";
