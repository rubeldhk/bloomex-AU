		...
		<tr>
			<td width="60%" valign="top">
				...
				<tr>
					...
					Intro Text: (required)
					<br />
                                        <textarea id="introtext" name="introtext" cols="60" rows="4"><?php echo (isset($row->introtext) ? $row->introtext : ''); ?></textarea>    
                                        <?php
				...
				<tr>
					...
					Main Text: (optional)
					<br />
                                        <textarea id="fulltext" name="fulltext" cols="60" rows="4"><?php echo (isset($row->fulltext) ? $row->fulltext : ''); ?></textarea>    
                                        <?php
					// parameters : areaname, content, hidden field, width, height, rows, cols
			...
			<td valign="top" width="40%">
				...
				<tr>
					...
					Page Title:
					<br />
					<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="page_title"><?php echo str_replace('&','&amp;', (isset($row->page_title) ? $row->page_title : "")); ?></textarea>
					</td>
				</tr>
				<tr>
					<td>
					Description:
					<br />
					<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="metadesc"><?php echo str_replace('&','&amp;',(isset($row->metadesc) ? $row->metadesc : "")); ?></textarea>
					</td>
				</tr>
					<tr>
					<td>
					Keywords:
					<br />
					<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="metakey"><?php echo str_replace('&','&amp;',(isset($row->metakey) ? $row->metakey : "")); ?></textarea>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					Page Title:
					<br />
					<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="page_title_fr"><?php echo str_replace('&','&amp;',(isset($row->page_title_fr) ? $row->page_title_fr : "")); ?></textarea>
					</td>
				</tr>
				<tr>
					<td>
					Description:
					<br />
					<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="metadesc_fr"><?php echo str_replace('&','&amp;',(isset($row->metadesc_fr) ? $row->metadesc_fr : "")); ?></textarea>
					</td>
				</tr>
					<tr>
					<td>
					Keywords:
					<br />
					<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="metakey_fr"><?php echo str_replace('&','&amp;',(isset($row->metakey_fr) ? $row->metakey_fr : "")); ?></textarea>
					</td>
				</tr>
				</table>
				<?php
