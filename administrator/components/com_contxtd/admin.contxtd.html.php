...
* ==================================================================
* @version $Id: admin.contxtd.html.php,v 1.2 2005/10/21 21:35:22 cubalibre Exp $
* @package Mambo
* @subpackage Contact
...
class HTML_contxtd{
	...
	function showContacts( &$rows, &$pageNav, $search, $option, &$lists ) {
		...
		for ($i=0, $n=count($rows); $i < $n; $i++) {
			...
			$link 	= 'index2.php?option=com_contxtd&task=editA&hidemainmenu=1&id='. $row->id;
			...
			// @CubaLibre: $row->cat_link 	= 'index2.php?option=com_categories&section=com_contacts&task=editA&hidemainmenu=1&id='. $row->catid;
			$row->cat_link 	= 'index2.php?option=com_categories&section=com_contxtd&task=editA&hidemainmenu=1&id='. $row->catid;
		...
		<tr>
			<td width="60%" valign="top">
				...
				<tr>
					...
					<td>
					<input class="inputbox" type="text" name="company" size="50" maxlength="50" value="<?php echo $row->company; ?>" />
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					...
					<td>
					<input class="inputbox" type="text" name="website" size="50" maxlength="50" value="<?php echo $row->website; ?>" />
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					...
					<td>
					<input class="inputbox" type="text" name="telephone1" size="25" maxlength="25" value="<?php echo $row->telephone1; ?>" />
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td>
					<input class="inputbox" type="text" name="telephone2" size="25" maxlength="25" value="<?php echo $row->telephone2; ?>" />
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					...
					<td>
					<input class="inputbox" type="text" name="mobile1" size="25" maxlength="25" value="<?php echo $row->mobile1; ?>" />
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td>
					<input class="inputbox" type="text" name="mobile2" size="25" maxlength="25" value="<?php echo $row->mobile2; ?>" />
					</td>
				</tr>
				<tr>
					...
					<td>
					<textarea name="misc1" rows="5" cols="50" class="inputbox"><?php echo $row->misc1; ?></textarea>
					</td>
				</tr>
				<tr>
					<td align="right" valign="top">
					...
					<td>
					<textarea name="misc2" rows="5" cols="50" class="inputbox"><?php echo $row->misc2; ?></textarea>
					</td>
				</tr>
				<tr>
				</table>
