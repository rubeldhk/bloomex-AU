...
class HTML_LandingPages {
            ...
            <table class="adminheading">
                ...
                <tr>
                    <td align="right" style="padding:0px 20px 10px 0px;">
                        <a href="index2.php?option=com_landingpages&act=setup_category" style="float:left;margin-left:50px;color:#0C00CA;font-size:14px;">Category Product Configuration</a>
                        <a href="#" style="float:left;margin-left:50px;color:#0C00CA;font-size:14px;">Update Links Database<span id="update-links-loader"></span></a>
                        <b>Filter By:&nbsp;</b>
        ...
        for ($i = 0, $n = count($rows); $i < $n; $i++) {
            ...
            ?>
                    <tr class="<?php echo "row$k"; ?>">
                        ...
                        <td align="left"><?php if ($row->lang == 1) echo "English";
            else echo "French"; ?></td>
                        <td align="center"><?php if ($row->enable_location > 0) echo "<b>Yes</b>";
            else echo "No"; ?></td>
    ...
    function editLandingPages(&$row, $option, &$lists) {
    ...
    function setupCategory($option) {
        ...
        <!--
            function submitbutton(pressbutton) {
                var form = document.adminForm;
                if (pressbutton == 'cancel') {
                    location.href = "index2.php?option=com_landingpages";
                }
