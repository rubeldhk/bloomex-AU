				...
				<table class="adminform">
					...
					<tr>
						<td>
							Page Title:
							<br />
							<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="en_meta_title"><?php echo str_replace('&','&amp;', (isset($row->en_meta_title) ? $row->en_meta_title : "")); ?></textarea>
						</td>
					</tr>
					<tr>
						<td>
							Description:
							<br />
							<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="en_meta_description"><?php echo str_replace('&','&amp;',(isset($row->en_meta_description) ? $row->en_meta_description : "")); ?></textarea>
						</td>
					</tr>
					<tr>
						<td>
							Keywords:
							<br />
							<textarea class="text_area" cols="30" rows="3" style="width: 350px; height: 50px" name="en_meta_keyword"><?php echo str_replace('&','&amp;',(isset($row->en_meta_keyword) ? $row->en_meta_keyword : "")); ?></textarea>
						</td>
					</tr>
