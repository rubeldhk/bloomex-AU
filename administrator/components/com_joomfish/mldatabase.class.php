...
class mlDatabase extends database {
	...
	/** Constructor
	*/
	function __construct( $host='localhost', $user, $pass, $db, $table_prefix='jos_', $driver='' ) {
		parent::__construct( $host, $user, $pass, $db, $table_prefix, $driver );
	...
	*/
	...
	function _getTableName() {
		...
		if (isset($mosConfig_dbprefix) && strlen($mosConfig_dbprefix)>0) $table = preg_replace( "/".$mosConfig_dbprefix."/", '', $table);
		$table = preg_replace( "/\n/", "", $table) ;
