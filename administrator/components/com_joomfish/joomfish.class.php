...
class JoomFishManager {
	...
	function __construct($adminPath=null) {
...
class ContentElementTable {
	...
	/** Standard constructor
	*/
	function __construct( $tableElement ) {
...
class ContentElementTablefield {
	...
	*/
	function __construct( $tablefieldElement ) {
...
class ContentObject {
	 ...
	 */
	function __construct( $languageID,& $contentElement, $id=-1 ) {
		global $database;
...
/** @var boolean Flag of the translation publishing status*/
	...
	*/
	 ...
	 */
	function bind( $newValues, $ignore='') {
