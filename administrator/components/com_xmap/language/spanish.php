...
if( !defined( 'JOOMAP_LANG' )) {
	...
	// New on Xmap 1.1
	define('_XMAP_MSG_SELECT_FOLDER','Por favor seleccione un directorio');
	define('_XMAP_UPLOAD_PKG_FILE','Subir archivo');
	define('_XMAP_UPLOAD_AND_INSTALL','Subir archivo e Instalarlo');
	define('_XMAP_INSTALL_F_DIRECTORY','Instalar desde un directorio');
	define('_XMAP_INSTALL_DIRECTORY','Directorio de instalaci&oacute;n');
