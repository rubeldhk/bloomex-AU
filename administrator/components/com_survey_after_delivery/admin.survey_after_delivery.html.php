            ...
            <table class="adminlist">
                ...
                for ($i=0, $n=count($rows); $i < $n; $i++) {
                    ...
                    <tr class="<?php echo "row$k"; ?>">
                        ...
                        <td align="center"><?php echo (!empty($aRate[$row->how_would_you_rate_the_freshness_and_appearance_of_your_items]) ? $aRate[$row->how_would_you_rate_the_freshness_and_appearance_of_your_items] : ""); ?></td>
        ...
        <script>
            ...
            function download() {
                jQuery.ajax({
                    data:
                        {
                            option: 'com_survey_after_delivery',
                            task: 'download',
                    ...
                    success: function (data)
                    {
                        ...
                        var a = $("<a />");
                        a.attr("download", 'recipients-survey-list-au.csv');
                        a.attr("href", link);
                        $("body").append(a);
                        a[0].click();
                        $("body").remove(a);
