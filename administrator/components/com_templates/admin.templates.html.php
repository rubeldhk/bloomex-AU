...
class HTML_templates {
	...
	*/
	static function showTemplates( &$rows, &$pageNav, $option, $client ) {
	...
	* @param string The option
	*/
	static function editTemplateSource( $template, &$content, $option, $client ) {
...
?>
	...
	* @param string The option
	*/
	static function editCSSSource( $template, &$content, $option, $client ) {
		global $mosConfig_absolute_path;
		$css_path =
			$mosConfig_absolute_path . ($client == 'admin' ? '/administrator' : '')
...
?>
	...
	* @param string The option
	*/
	static function assignTemplate( $template, &$menulist, $option ) {
		?>
		<form action="index2.php" method="post" name="adminForm">
		<table class="adminform">
		<tr>
	...
	* @param string The option
	*/
	static function editPositions( &$positions, $option ) {
		$rows = 25;
		$cols = 2;
		$n = $rows * $cols;
		?>
