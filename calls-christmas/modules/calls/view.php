                ...
                <div class="col call">
                    ...
                    <form role="form" id="company">
                        ...
                        <div class="buttons first" style="margin-bottom: 1rem;">
                            <button type="submit" class="btn btn-info" id="btn_start_call" style="margin-bottom: 8px;">
                                <img src="<?php echo MY_PATH; ?>/static/images/phone_call.png" style="width: 25px;"> <b>START CALL</b>
                            </button><br>
                        </div>
                        <div class="buttons first" style="margin-bottom: 1rem;">
    ...
    public function setLoginForm($obj, $default_class) {
        ...
        <div class="container">
            <div class="row any justify-content-md-center">
                <form class="form-inline login-form" role="form" method="POST" action="<?php echo MY_PATH; ?>/index.php?task=login">
