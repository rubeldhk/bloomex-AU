...
class HTML_Survey_after_order {
    ...
    function viewPage($user_id, $order_id) {
        ...
        <div class="container padding-0">
            <form method="post" action="index.php?option=com_survey_after_order&task=save&user_id=<?php echo $user_id ?>&order_id=<?php echo $order_id ?>" class="form-survey" id="form-survey">
                <div class="body-survey">
                    ...
                    <div class="rate-survey-body">
                        ...
                        <p class="survey_section_title"><strong>How did you place your order? </strong></p>
                        <div class='rating-radio '>
                            ...
                            <label>
                                <input type="radio" name="place_order" value="Website" />
                                <span>Website</span>
                            </label>
                            <label>
                                <input type="radio" name="place_order" value="notPlace" />
                                <span>I received a product. I did not place an order.</span>
                            </label>
                        </div>
                        ...
                        <table class="survey_table">
                            ...
                            <tr>
                                <td>How would you rate the Bloomex website?</td>
                                <td>
                            ...
                            <tr>
                                <td>How would you rate the Bloomex product selection and prices?</td>
                                <td>
                                    <div class='rating-stars '>
                            ...
                            <tr>
                                <td>How would you rate the Bloomex ordering process?</td>
                                <td>
                                    <div class='rating-stars '>
                            ...
                            <tr>
                                <td>How would you rate your Customer Service experience (if applicable)?</td>
                                <td>
                                    <div class='rating-stars '>
                            ...
                            <tr>
                                <td>How likely are you to recommend Bloomex to others?</td>
                                <td>
                                    <div class='rating-stars '>
                        ...
                        <div class="submit-survey">
                            <input type="hidden" name="option" value="com_survey_after_order"/>
