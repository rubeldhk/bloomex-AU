...
// ------------------------------------------------------------------------------------------
   ...
   if(wFORMS) {
		...
		wFORMS.className_validationError_hid	= "errMsgHidden";  
		...
		wFORMS.behaviors['validation'] = {
           ...
           run: function(e) {
			...
			showError: function (element,errorMsg) {		
				...
				// DBQ MODIFICATION - append here
				if (wFORMS.behaviors['validation'].useDefaultErrorMessages)
			...
			removeErrorMessage: function(element) {
				...
				if ( errorMessage ) 
					errorMessage.className = wFORMS.className_validationError_hid;


/*
				//var rErrClass     = new RegExp(wFORMS.className_validationError_fld,"gi");

				var rErrClassVisible = wFORMS.className_validationError_fld;
				var rErrClassHidden = wFORMS.className_validationError_hid;

				var errorMessage  = document.getElementById(element.id + wFORMS.idSuffix_fieldError);
				// DBQ MODIFICATION
				//if(errorMessage)  errorMessage.parentNode.removeChild(errorMessage);
				if(errorMessage)
				errorMessage.className = element.className.replace(rErrClassVisible,eErrClassHidden);
*/
			}
