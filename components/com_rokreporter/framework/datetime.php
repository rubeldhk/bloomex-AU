<?php
/**
 * @version $Id: datetime.php 9 2007-04-13 04:08:48Z eddieajau $
 * @package JamboWorks
 * @subpackage Libraries
 * @copyright (C) 2006 JamboWorks LLC. All rights reserved.
...
class JDate {
	 ...
	 */
	function addDays( $n ) {
		$this->setDate( $this->getTime() + SECONDS_IN_DAY * $n, DATE_FORMAT_UNIXTIME );
	}
