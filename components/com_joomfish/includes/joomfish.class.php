...
class MambelFish{
	...
	static function translate( $content, $reference_table, $language, $tableArray=array())	{ MambelFish::warnAdmin(); return $content;}
	static function translateList( $rows, $reference_table, $language , $tableArray) {	  MambelFish::warnAdmin(); return $rows;}
}
...
class JoomFish {
	...
	static function translateList( &$rows, $reference_table, $language , $tableArray) {
...
//				JoomFish:: translateListOLD( $rows, $reftable, $language );
	 ...
	 *
	 */
	static function translate( &$content, $reference_table, $language, $tableArray=array())
	{
	 ...
	 * @return void
	 */
	static function translateWithID( &$content, $id, $reference_table, $language, $refTablePrimaryKey="id", $tableArray)
	{
		/**
	...
	/**
	  * Function to translate a section object
	  */
	static function translateListWithIDs( &$rows, $ids, $reference_table, $language, $refTablePrimaryKey="id", $tableArray)
	{
	 ...
	 * @param string $reference_table
	 */
	static function processMissingTranslation(&$row_to_translate, $language,$reference_table){
