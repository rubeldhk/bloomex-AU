...
/**
*
* @version $Id: virtuemart.php,v 1.8.2.10 2006/09/09 11:31:40 soeren_nb Exp $
* @package VirtueMart
* @subpackage core
...
<link type=\"text/css\" rel=\"stylesheet\" media=\"screen, projection\" href=\"".$GLOBALS['mosConfig_live_site']."/components/$option/css/shop.css\" />" );
            } else {
				?>
<script type="text/javascript" src="<?php echo "$mosConfig_live_site/components/$option" ?>/js/sleight.js"></script>
<link type="text/css" rel="stylesheet" media="screen, projection" href="<?php echo $GLOBALS['mosConfig_live_site']; ?>/components/<?php echo $option ?>/css/shop.css" />
				<?php
			}
