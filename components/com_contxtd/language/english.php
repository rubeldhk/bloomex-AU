...
* ==================================================================
* $Id: english.php, v1.0 2005/06/06
* @package ContXTD
...
/** add new definitions */
DEFINE('_CONTACT_HEADER_COMPANY','Company');
DEFINE('_CONTACT_HEADER_MOBILE','Mobile');

DEFINE('_CONTACT_COMPANY','Company');
DEFINE('_CONTACT_WEBSITE','Website');
DEFINE('_CONTACT_MISC2','Information');

DEFINE('_CONTACT_BLOG_EMAIL','Send an Email to this contact');
?>
