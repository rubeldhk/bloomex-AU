...
function sefRelToAbs( $string ) {
	...
	if( $mosConfig_sef && ($mosConfig_mbf_content || $mosConfig_multilingual_support) && $string!='index.php' && !preg_match("/^(([^:\/?#]+):)/i",$string) && !strcasecmp(substr($string,0,9),'index.php') && !preg_match('/lang=/i', $string) ) {
