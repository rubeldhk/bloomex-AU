...
class gacl {
	...
	function __construct( $db=null ) {
		...
		// access to language
		//$this->_mos_add_acl( 'administration', 'manage', 'users', 'manager', 'components', 'com_languages' );
		...
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'manager', 'components', 'com_virtuemart' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'manager', 'components', 'com_virtuemart' );
		...
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'manager', 'components', 'com_phoneorder' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'manager', 'components', 'com_phoneorder' );
