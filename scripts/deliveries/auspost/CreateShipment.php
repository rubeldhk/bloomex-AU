                            ...
                            <div class="cp_fieldset">
                                <fieldset>
                                    ...
                                    <div>
                                        ...
                                        <p class="pickup_text">no need to declare shipping dates for returns as those transactions are billed when are picked up only
                                            Order Delivery Date: <span class="delivery_date"><?php echo $BloomexOrder->_deliverydate;?></span></p>
                                        <br><span id="lable">pickup date:</span>
