...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    */
     ...
     * @return array
     */
	public function toArray($nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false,$highestcolumn = null) {
        // Garbage collect...
        $this->garbageCollect();

        //    Identify the range that we need to extract from the worksheet
        $maxCol = $highestcolumn?$highestcolumn:$this->getHighestColumn();
