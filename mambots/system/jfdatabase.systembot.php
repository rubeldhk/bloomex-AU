...
function botJFDiscoverLanguage() {
    ...
    if ($client_lang == '') {
        if ($newVisitorAction == "browser" && isset($_SERVER["http_accept_language"])) {
    ...
    setcookie("lang", "", time() - 1800, "/; SameSite=Strict",'',true,true);
    setcookie("mbfcookie", "", time() - 1800, "/; SameSite=Strict",'',true,true);
    setcookie("mbfcookie[lang]", $client_lang, time() + 24 * 3600, '/; SameSite=Strict',"",true,true);
