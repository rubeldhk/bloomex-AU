                ...
                <div class="col call">
                    ...
                    <form role="form" id="company">
                        ...
                        <div class="buttons first" style="margin-bottom: 1rem;">
                            <button type="submit" class="btn btn-primary" id="btn_sale">
                                <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span>
                                BUYER
                            </button>
                        ...
                        <div class="buttons first">
                            <button type="submit" class="btn btn-success" id="btn_disturb">
                                <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span>
                                HOT LEAD 
                            </button>
                            <button type="submit" class="btn btn-danger" id="btn_bad_number">
                                <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span>
                                NO INTERESTED
                            </button>
                        </div>
        ...
        <div class="container">
            <div class="row any justify-content-md-center">
                <form class="form-inline login-form" role="form" method="POST" action="<?php echo MY_PATH; ?>/?task=login">
                    ...
                    <button type="submit" class="btn btn-dark mt-2 mb-2" style="margin-right: 10px;" name="project" value="1">GO</button>
                </form>
            </div>
        </div>
        <?php
